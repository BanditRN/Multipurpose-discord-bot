            ...
            interaction?.reply({
                ...
                embeds: [
                    new Discord.EmbedBuilder()
                        .setAuthor({ name: handlemsg(client.la[ls].cmds.info.invites.author, { usertag: user.tag }), iconURL: user.displayAvatarURL({ dynamic: true }) || undefined, url: "https://discord.gg/milrato" || undefined })
                        .setColor(es.color)
                        .setThumbnail(
                            es.thumb
