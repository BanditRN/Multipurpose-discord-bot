...
const { buildUnresolvedTrack } = require("lavalink-client");
                            ...
                            return message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["customqueues"]["savedqueue"]["variable4"])
                                        ),
                                ],
                            });
                        if (Name.length > 10)
                            ...
                            return message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["customqueues"]["savedqueue"]["variable8"])
                                        ),
                                ],
                            });
                        client.queuesaves.set(
                            message.author.id,
                            {
                            ...
                            return message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["customqueues"]["savedqueue"]["variable12"])
                                        ),
                                ],
                            });
                        if (Name.length > 10)
                            ...
                            return message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["customqueues"]["savedqueue"]["variable16"])
                                        ),
                                ],
                            });
                            ...
                            return message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["customqueues"]["savedqueue"]["variable21"])
                                        ),
                                ],
                            });
                        if (Name.length > 10)
                            ...
                            return message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["customqueues"]["savedqueue"]["variable25"])
                                        ),
                                ],
                            });
                        //get the player instance
                            ...
                            return message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["customqueues"]["savedqueue"]["variable31"])
                                        ),
                                ],
                            });
                        if (Name.length > 10)
                            ...
                            return message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["customqueues"]["savedqueue"]["variable35"])
                                        ),
                                ],
                            });
                            ...
                            return message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["customqueues"]["savedqueue"]["variable37"])
                                        ),
                                ],
                            });
                            ...
                            return message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["customqueues"]["savedqueue"]["variable39"])
                                        ),
                                ],
                            });
                            ...
                            return message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["customqueues"]["savedqueue"]["variable42"])
                                        ),
                                ],
                            });
                        if (Name.length > 10)
                            ...
                            return message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["customqueues"]["savedqueue"]["variable46"])
                                        ),
                                ],
                            });
                        let oldtracks = client.queuesaves.get(message.author.id, `${Name}`);
                            ...
                            return message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["customqueues"]["savedqueue"]["variable48"])
                                        ),
                                ],
                            });
                            ...
                            return message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["customqueues"]["savedqueue"]["variable51"])
                                        ),
                                ],
                            });
                        if (Name.length > 10)
                            ...
                            return message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["customqueues"]["savedqueue"]["variable57"])
                                        ),
                                ],
                            });
                            ...
                            return message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["customqueues"]["savedqueue"]["variable60"])
                                        ),
                                ],
                            });
                        let description = ``;
                            ...
                            return message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["customqueues"]["savedqueue"]["variable62"])
                                        ),
                                ],
                            });
                        if (Name.length > 10)
                            ...
                            return message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["customqueues"]["savedqueue"]["variable66"])
                                        ),
                                ],
                            });
                        //get the player instance
                            ...
                            return message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["customqueues"]["savedqueue"]["variable72"])
                                        ),
                                ],
                            });
                        if (Name.length > 10)
                            ...
                            return message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["customqueues"]["savedqueue"]["variable76"])
                                        ),
                                ],
                            });
                        //delete it
                ...
                case `paly`:
                    {
                            ...
                            return message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["customqueues"]["savedqueue"]["variable79"])
                                        ),
                                ],
                            });
                        if (Name.length > 10)
                            ...
                            return message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["customqueues"]["savedqueue"]["variable84"])
                                        ),
                                ],
                            });
                            ...
                            return message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["customqueues"]["savedqueue"]["variable86"])
                                        ),
                                ],
                            });
                        //if the queue does not exist yet, error
                            ...
                            return message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["customqueues"]["savedqueue"]["variable88"])
                                        ),
                                ],
                            });
                        ...
                        for (const track of client.queuesaves.get(message.author.id, `${Name}`)) {
                            try {
                                ...
                                const unresolvedTrack = buildUnresolvedTrack(
                                    {
                                        title: track.title,
                                        uri: track.url,
                                        author: "Unknown",
                ...
                case `details`:
                    {
                            ...
                            return message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["customqueues"]["savedqueue"]["variable93"])
                                        ),
                                ],
                            });
                        if (Name.length > 10)
                            ...
                            return message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["customqueues"]["savedqueue"]["variable97"])
                                        ),
                                ],
                            });
                        //get all tracks
                        ...
                        tracks
                            .map((track, index) =>
                                array.push(
                                    `**${index})** [${track.title.split(`]`).join(`}`).split(`[`).join(`{`).substring(0, 60)}](${track.url})`
                                )
                            )
                            .join(`\n`);
                        return swap_pages(
                            ...
                            message,
                            array,
                            `Detailed Information about: \`${Name}\` [${tracks.length} Tracks]`
                        );
                    }
                    break;
                default:
