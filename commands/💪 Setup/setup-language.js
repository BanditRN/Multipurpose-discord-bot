        ...
        try {
            ...
            async function first_layer() {
                ...
                let MenuEmbed = new EmbedBuilder()
                    .setColor(es.color)
                    .setAuthor({ name: "Language System Setup", iconURL: "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/282/flag-united-kingdom_1f1ec-1f1e7.png", url: "https://discord.gg/milrato" })
                ...
                function menuselection(menu) {
                    ...
                    if (menu?.values[0] == "Cancel")
                        return menu?.reply(eval(client.la[ls]["cmds"]["setup"]["setup-language"]["variable2"]));
                    menu?.deferUpdate();
                    used1 = true;
                    ...
                    case 0: {
                        ...
                        collector.on("collect", async b => {
                            if (b?.user.id !== message.author.id)
                                return b?.reply(
                                    `<:no:833101993668771842> **Only the one who typed ${prefix}setup-language is allowed to react!**`,
                                    true
                                );
                            if (
                                b?.user.id == message.author.id &&
                                b?.message.id == helpmsg.id &&
                                b?.customId.includes("language_")
                            ) {
                                b?.deferUpdate();
