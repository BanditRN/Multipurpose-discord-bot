    ...
    run: async (client, message, args, cmduser, text, prefix) => {
        ...
        async function second_layer(SetupNumber, menuoptiondata) {
            try {
                ...
                let menuoptions = [
                    ...
                    {
                        value: apply_for_here.get(message.guild.id, `${pre}.last_verify`)
                            ? "Enable Last Verify"
                            : "Disable Last Verify",
                        description: apply_for_here.get(message.guild.id, `${pre}.last_verify`)
                            ? "Enabled Last Verification Message for the User"
                            : "Disabled Last Verification Message for the User",
                        emoji: "✋",
                    },
                    {
                        value: "Cancel",
                ...
                let Selection = new StringSelectMenuBuilder()
                    ...
                    .setMinValues(1)
                    .setPlaceholder(
                        `Click me to manage the ${SetupNumber} Apply System!\n\n**You've picked:**\n> ${menuoptiondata.value}`
                    )
                    .addOptions(
                ...
                let MenuEmbed = new EmbedBuilder()
                    .setColor(es.color)
                    .setAuthor({ name: SetupNumber + " Apply Setup", iconURL: "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/282/incoming-envelope_1f4e8.png", url: "https://discord.gg/milrato" })
        ...
        async function handle_the_picks(optionhandletype) {
            try {
                ...
                if (optionhandletype == "Enable Last Verify" || optionhandletype == "Disable Last Verify")
                    args = `${pre}.last_verify`;
                switch (args) {
                    case "create":
                        {
                            var color = "GREEN";
                            ...
                            var collector = pickmsg.createMessageComponentCollector({
                                filter: interaction =>
                                    interaction?.isButton() &&
                                    interaction?.message.author.id == client.user.id &&
                                    interaction?.user.id == cmduser.id,
                                max: 1,
                                time: 180000,
                                erros: ["time"],
                            });
                                ...
                                pickmsg = await message.reply({
                                    embeds: [
                                        new EmbedBuilder()
                                            ...
                                            .setDescription(
                                                eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable33_1"])
                                            )
                                            .setFooter(client.getFooter(es)),
                                    ],
                                });
                                await pickmsg.channel
                                    .awaitMessages({
                                ...
                                pickmsg = await message.reply({
                                    embeds: [
                                        new EmbedBuilder()
                                            ...
                                            .setDescription(
                                                eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable37_1"])
                                            )
                                            .setFooter(client.getFooter(es)),
                                    ],
                                });
                                ...
                                var msg = await message.reply({
                                    embeds: [
                                        embed
                                            ...
                                            .setDescription(
                                                eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable42_1"])
                                            ),
                                    ],
                                });
                                    ...
                                    .then(collected => {
                                        ...
                                        if (!content.startsWith("#") && content.length !== 7) {
                                            ...
                                            if (isValidColor(content)) {
                                                ...
                                                message.reply({
                                                    content: eval(
                                                        client.la[ls]["cmds"]["setup"]["setup-apply"]["variable44"]
                                                    ),
                                                });
                                            }
                                        }
                                    ...
                                    .reply({
                                        embeds: [
                                            embed
                                                ...
                                                .setDescription(
                                                    eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable46_1"])
                                                ),
                                        ],
                                    })
                                    .then(msg => {
                                        msg.channel
                                            ...
                                            .then(collected => {
                                                ...
                                                var setupembed = new EmbedBuilder()
                                                    ...
                                                    .setDescription(desc)
                                                    .setTitle(
                                                        eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable47"])
                                                    )
                                                    .setFooter(client.getFooter(es));
                                                    ...
                                                    message
                                                        ...
                                                        .then(msg => {
                                                            msg.channel
                                                                ...
                                                                .then(collected => {
                                                                    if (
                                                                        collected.first().content.toLowerCase() === "finish"
                                                                    ) {
                                                                        return ask_addrole();
                                                                    }
                                                                    switch (counter) {
                                    ...
                                    msg.channel
                                        ...
                                        .then(collected => {
                                            ...
                                            if (!role)
                                                return message.reply({
                                                    content: eval(
                                                        client.la[ls]["cmds"]["setup"]["setup-apply"]["variable69"]
                                                    ),
                                                });
                                            var guildrole = message.guild.roles.cache.get(role.id);
                                            ...
                                            .edit({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setFooter({ text: "Pick the INDEX NUMBER / send the IMAGE URl", iconURL: client.user.displayAvatarURL() })
                                                        ...
                                                        function attachIsImage(msgAttach) {
                                                            ...
                                                            return (
                                                                url.indexOf("png", url.length - "png".length /*or 3*/) !==
                                                                    -1 ||
                                                                url.indexOf("jpeg", url.length - "jpeg".length /*or 3*/) !==
                                                                    -1 ||
                                                                url.indexOf("gif", url.length - "gif".length /*or 3*/) !==
                                                                    -1 ||
                                                                url.indexOf("webp", url.length - "webp".length /*or 3*/) !==
                                                                    -1 ||
                                                        ...
                                                        .then(collected => {
                                                            ...
                                                            function attachIsImage(msgAttach) {
                                                                ...
                                                                return (
                                                                    ...
                                                                    url.indexOf(
                                                                        "gif",
                                                                        url.length - "gif".length /*or 3*/
                                                                    ) !== -1 ||
                                                                    url.indexOf(
                                                                        "webp",
                                                                        url.length - "webp".length /*or 3*/
                                                                    ) !== -1 ||
                                                                    url.indexOf(
                                                                        "jpg",
                                            ...
                                            .edit({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setTitle(
                                                            eval(
                                                                client.la[ls]["cmds"]["setup"]["setup-apply"]["variable123"]
                                                            )
                                                        )
                                                        .setDescription(
                                                            eval(
                                            ...
                                            .edit({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setTitle(
                                                            eval(
                                                                client.la[ls]["cmds"]["setup"]["setup-apply"]["variable144"]
                                                            )
                                                        )
                                                        .setDescription(
                                                            eval(
                                            ...
                                            .edit({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setTitle(
                                                            eval(
                                                                client.la[ls]["cmds"]["setup"]["setup-apply"]["variable164"]
                                                            )
                                                        )
                                                        .setDescription(
                                                            eval(
                    ...
                    case "editquestion":
                        {
                            ...
                            var embed = new EmbedBuilder()
                                ...
                                .setFooter({ text: "ADD THE INDEX TO EDIT THE MSG", iconURL: message.guild.iconURL({
                                        dynamic: true,
                                    }) })
                                .setTimestamp();
                                ...
                                .reply({
                                    embeds: [
                                        ...
                                        new EmbedBuilder()
                                            ...
                                            .setDescription(
                                                eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable176"])
                                            ),
                                    ],
                                })
                                .then(msg => {
                                                    ...
                                                    .then(msg => {
                                                        msg.channel
                                                            ...
                                                            .then(collected => {
                                                                ...
                                                                Questions = apply_for_here.get(
                                                                    message.guild.id,
                                                                    pre + ".QUESTIONS"
                                                                );
                                                                var new_embed = new EmbedBuilder()
                                                                    .setFooter(client.getFooter(es))
                                                                    .setColor(es.color)
                                                                    .setTitle(
                                                                        eval(
                                ...
                                .reply({
                                    embeds: [
                                        new EmbedBuilder()
                                            ...
                                            .setDescription(
                                                eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable187"])
                                            ),
                                    ],
                                })
                                .then(msg => {
                                ...
                                .reply({
                                    embeds: [
                                        ...
                                        new EmbedBuilder()
                                            ...
                                            .setDescription(
                                                eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable192"])
                                            ),
                                    ],
                                })
                                .then(msg => {
                                            ...
                                            .reply({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setTitle(
                                                            eval(
                                                                client.la[ls]["cmds"]["setup"]["setup-apply"]["variable197"]
                                                            )
                                                        )
                                                        .setDescription(
                                                            eval(
                                                                client.la[ls]["cmds"]["setup"]["setup-apply"]["variable198"]
                                                            )
                                                        ),
                                                ],
                                            })
                            ...
                            var msg = await message.reply({
                                embeds: [
                                    embed
                                        ...
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable201_1"])
                                        ),
                                ],
                            });
                            await msg.channel
                            ...
                            await message.reply({
                                embeds: [
                                    embed
                                        ...
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable205_1"])
                                        ),
                                ],
                            });
                            await msg.channel
                                    ...
                                    return message.reply({
                                        embeds: [
                                            new EmbedBuilder()
                                                ...
                                                .setDescription(
                                                    eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable208"])
                                                ),
                                        ],
                                    });
                                })
                                ...
                                .reply({
                                    embeds: [
                                        new EmbedBuilder()
                                            ...
                                            .setDescription(
                                                eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable211"])
                                            ),
                                    ],
                                })
                                .then(msg =>
                                            ...
                                            .reply({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setTitle(
                                                            eval(
                                                                client.la[ls]["cmds"]["setup"]["setup-apply"]["variable213"]
                                                            )
                                                        )
                                                        .setDescription(
                                                            eval(
                                                                client.la[ls]["cmds"]["setup"]["setup-apply"]["variable214"]
                                                            )
                                                        ),
                                                ],
                                            })
                                ...
                                .reply({
                                    embeds: [
                                        new EmbedBuilder()
                                            ...
                                            .setDescription(
                                                eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable218"])
                                            ),
                                    ],
                                })
                                .then(msg =>
