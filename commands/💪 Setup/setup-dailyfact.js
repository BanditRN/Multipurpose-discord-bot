        ...
        try {
            ...
            async function first_layer() {
                ...
                let MenuEmbed = new EmbedBuilder()
                    .setColor(es.color)
                    .setAuthor({ name: "Daily Facts Setup", iconURL: "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/apple/285/page-with-curl_1f4c3.png", url: "https://discord.gg/milrato" })
                            ...
                            let tempmsg = await message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setColor(es.color)
                                        .setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-dailyfact"]["variable6"]))
                                    ...
                                    if (channel) {
                                        ...
                                        return message.reply({
                                            embeds: [
                                                new EmbedBuilder()
                                                    .setTitle(
                                                        eval(client.la[ls]["cmds"]["setup"]["setup-dailyfact"]["variable7"])
                                                    )
                                                    .setColor(es.color)
