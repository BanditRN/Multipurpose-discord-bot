...
var { databasing, delay } = require(`${process.cwd()}/handlers/functions`);
module.exports = {
    name: "setup-antinuke",
    category: "💪 Setup",
            ...
            async function first_layer() {
                ...
                async function menuselection(menu) {
                    if (menu?.values[0] == "Cancel")
                        return menu?.reply({ content: eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable4"]) });
                    used1 = true;
                    if (menu?.values[0] == "Information") {
                        ...
                        async function menuselection2(menu) {
                            if (menu?.values[0] == "Cancel")
                                return menu?.reply({
                                    content: eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable17"]),
                                });
                            used1 = true;
                            ...
                            if (String(index) == "0") {
                                ...
                                let tempmsg = await message.reply({
                                    embeds: [
                                        new EmbedBuilder()
                                            ...
                                            .setColor(es.color)
                                            .setDescription(
                                                eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable19"])
                                            )
                                            .setFooter(client.getFooter(es)),
                                    ],
                                });
                                ...
                                let tempmsg = await message.reply({
                                    embeds: [
                                        new EmbedBuilder()
                                            ...
                                            .setColor(es.color)
                                            .setDescription(
                                                eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable25"])
                                            )
                                            .setFooter(client.getFooter(es)),
                                    ],
                                });
                                ...
                                let tempmsg = await message.reply({
                                    embeds: [
                                        new EmbedBuilder()
                                            ...
                                            .setColor(es.color)
                                            .setDescription(
                                                eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable31"])
                                            )
                                            .setFooter(client.getFooter(es)),
                                    ],
                                });
                                await tempmsg.channel
                                    ...
                                    .then(async collected => {
                                        ...
                                        let removedusers = [];
                                        let removedroles = [];
                                        let current = client.Anti_Nuke_System.get(
                                            message.guild.id,
                                            "antideleteuser.whitelisted"
                                        );
                                        for (const u of users) {
                                            if (current.users.includes(u)) {
                                                removedusers.push(u);
                                        ...
                                        for (const u of addedusers) {
                                            client.Anti_Nuke_System.push(
                                                message.guild.id,
                                                u,
                                                "antideleteuser.whitelisted.users"
                                            );
                                        }
                                        for (const r of addedroles) {
                                            client.Anti_Nuke_System.push(
                                                message.guild.id,
                                                r,
                                                "antideleteuser.whitelisted.roles"
                                            );
                                        }
                                        for (const u of removedusers) {
                                            client.Anti_Nuke_System.remove(
                                                message.guild.id,
                                                u,
                                                "antideleteuser.whitelisted.users"
                                            );
                                ...
                                let tempmsg = await message.reply({
                                    embeds: [
                                        new EmbedBuilder()
                                            ...
                                            .setColor(es.color)
                                            .setDescription(
                                                eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable37"])
                                            )
                                            .setFooter(client.getFooter(es)),
                                    ],
                                });
                                    ...
                                    .then(async collected => {
                                        ...
                                        for (const u of addedusers) {
                                            client.Anti_Nuke_System.push(
                                                message.guild.id,
                                                u,
                                                "anticreaterole.whitelisted.users"
                                            );
                                        }
                                        for (const r of addedroles) {
                                            client.Anti_Nuke_System.push(
                                                message.guild.id,
                                                r,
                                                "anticreaterole.whitelisted.roles"
                                            );
                                        }
                                        for (const u of removedusers) {
                                            client.Anti_Nuke_System.remove(
                                ...
                                let tempmsg = await message.reply({
                                    embeds: [
                                        new EmbedBuilder()
                                            ...
                                            .setColor(es.color)
                                            .setDescription(
                                                eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable43"])
                                            )
                                            .setFooter(client.getFooter(es)),
                                    ],
                                });
                                    ...
                                    .then(async collected => {
                                        ...
                                        for (const u of addedusers) {
                                            client.Anti_Nuke_System.push(
                                                message.guild.id,
                                                u,
                                                "antideleterole.whitelisted.users"
                                            );
                                        }
                                        for (const r of addedroles) {
                                            client.Anti_Nuke_System.push(
                                                message.guild.id,
                                                r,
                                                "antideleterole.whitelisted.roles"
                                            );
                                        }
                                        for (const u of removedusers) {
                                            client.Anti_Nuke_System.remove(
                                ...
                                let tempmsg = await message.reply({
                                    embeds: [
                                        new EmbedBuilder()
                                            ...
                                            .setColor(es.color)
                                            .setDescription(
                                                eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable49"])
                                            )
                                            .setFooter(client.getFooter(es)),
                                    ],
                                });
                                    ...
                                    .then(async collected => {
                                        ...
                                        for (const u of addedusers) {
                                            client.Anti_Nuke_System.push(
                                                message.guild.id,
                                                u,
                                                "antichanneldelete.whitelisted.users"
                                            );
                                        }
                                        for (const r of addedroles) {
                                            client.Anti_Nuke_System.push(
                                                message.guild.id,
                                                r,
                                                "antichanneldelete.whitelisted.roles"
                                            );
                                        }
                                        for (const u of removedusers) {
                                            client.Anti_Nuke_System.remove(
                                ...
                                let tempmsg = await message.reply({
                                    embeds: [
                                        new EmbedBuilder()
                                            ...
                                            .setColor(es.color)
                                            .setDescription(
                                                eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable55"])
                                            )
                                            .setFooter(client.getFooter(es)),
                                    ],
                                });
                                    ...
                                    .then(async collected => {
                                        ...
                                        for (const u of addedusers) {
                                            client.Anti_Nuke_System.push(
                                                message.guild.id,
                                                u,
                                                "antichannelcreate.whitelisted.users"
                                            );
                                        }
                                        for (const r of addedroles) {
                                            client.Anti_Nuke_System.push(
                                                message.guild.id,
                                                r,
                                                "antichannelcreate.whitelisted.roles"
                                            );
                                        }
                                        for (const u of removedusers) {
                                            client.Anti_Nuke_System.remove(
                                ...
                                return menu?.reply({
                                    content: eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable60"]),
                                });
                            }
                        }
                        ...
                        menuoptions = [
                            {
                                value: client.Anti_Nuke_System.get(message.guild.id, "all.enabled")
                                    ? "Disable complete AntiNuke"
                                    : "Enable complete Anti Nuke",
                                description: client.Anti_Nuke_System.get(message.guild.id, "all.enabled")
                                    ? "I will not work anymore"
                                    : "I will be enabled",
                                emoji: client.Anti_Nuke_System.get(message.guild.id, "all.enabled")
                                    ? allEmojis.msg.ERROR
                            ...
                            {
                                value: client.Anti_Nuke_System.get(message.guild.id, "all.showwhitelistlog")
                                    ? "Disable Whitelisted Log"
                                    : "Enable Whitelisted Log",
                                description: client.Anti_Nuke_System.get(message.guild.id, "all.showwhitelistlog")
                                    ? "I will not show when a whitelisted User makes smt"
                                    : "I will show when a whitelisted User makes smt (I won't do smt tho)",
                                emoji: client.Anti_Nuke_System.get(message.guild.id, "all.showwhitelistlog")
                                    ? allEmojis.msg.ERROR
                                    : allEmojis.msg.SUCCESS,
                            },
                            {
                        ...
                        async function menuselection3(menu) {
                            if (menu?.values[0] == "Cancel")
                                return menu?.reply({
                                    content: eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable63"]),
                                });
                            used1 = true;
                            let index = menuoptions.findIndex(v => v.value == menu?.values[0]);
                            //Toggle
                            if (String(index) == "0") {
                                client.Anti_Nuke_System.set(
                                    message.guild.id,
                                    !client.Anti_Nuke_System.get(message.guild.id, "all.enabled"),
                                    "all.enabled"
                                );
                                return menu?.reply({
                                    embeds: [
                                ...
                                let tempmsg = await message.reply({
                                    embeds: [
                                        new EmbedBuilder()
                                            ...
                                            .setColor(es.color)
                                            .setDescription(
                                                eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable68"])
                                            )
                                            .setFooter(client.getFooter(es)),
                                    ],
                                });
                                            ...
                                            return message.reply({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setColor(es.color)
                                                        .setDescription(
                                                            `If some Anti-Nuke actions are needed to be executed, i will log them there!`.substring(
                                                                0,
                                                                2048
                                                            )
                                                        )
                                ...
                                client.Anti_Nuke_System.set(
                                    message.guild.id,
                                    !client.Anti_Nuke_System.get(message.guild.id, "all.showwhitelistlog"),
                                    "all.showwhitelistlog"
                                );
                                return menu?.reply({
                                    embeds: [
                                        new EmbedBuilder()
                                ...
                                let tempmsg = await message.reply({
                                    embeds: [
                                        new EmbedBuilder()
                                            ...
                                            .setColor(es.color)
                                            .setDescription(
                                                eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable77"])
                                            )
                                            .setFooter(client.getFooter(es)),
                                    ],
                                });
                                await tempmsg.channel
                                    ...
                                    .then(async collected => {
                                        ...
                                        if (message.mentions.roles.filter(r => r.guild.id == message.guild.id).first()) {
                                            client.Anti_Nuke_System.set(
                                                message.guild.id,
                                                message.mentions.roles.filter(r => r.guild.id == message.guild.id).first()
                                                    .id,
                                                `all.quarantine`
                                            );
                                            return message.reply({
                   ...
                   */
                                ...
                                async function first_layer() {
                                    menuoptions = [
                                        {
                                            value: client.Anti_Nuke_System.get(message.guild.id, `${thekey}.enabled`)
                                                ? `Disable ${thename}`
                                                : `Enable ${thename}`,
                                            description: client.Anti_Nuke_System.get(message.guild.id, `${thekey}.enabled`)
                                                ? `${thename} will stop working`
                                                : `${thename} will be working`,
                                            emoji: client.Anti_Nuke_System.get(message.guild.id, `${thekey}.enabled`)
                                                ? allEmojis.msg.ERROR
                                                : allEmojis.msg.SUCCESS,
                                        },
                                        {
                                    ...
                                    client.on("interactionCreate", menu => {
                                        if (menu?.message.id === menumsg.id) {
                                            if (menu?.user.id === cmduser.id) {
                                                ...
                                                if (menu?.values[0] == "Cancel")
                                                    return menu?.reply(
                                                        eval(client.la[ls]["cmds"]["setup"]["setup-warn"]["variable3"])
                                                    );
                                                menu?.deferUpdate();
                                                used33 = true;
                                                if (
                                                    menu?.values[0] ==
                                                    client.Anti_Nuke_System.get(message.guild.id, `${thekey}.enabled`)
                                                        ? `Disable ${thename}`
                                                        : `Enable ${thename}`
                                                ) {
                                                    client.Anti_Nuke_System.set(
                                                    ...
                                                    return message.reply(
                                                        `${client.Anti_Nuke_System.get(message.guild.id, `${thekey}.enabled`) ? `Enabled: ${thename}` : `Disabled: ${thename}`}`
                                                    );
                                                }
                        ...
                        if (!role || role.length <= 5) {
                            return menu?.reply({
                                content: eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable92"]),
                            });
                        }
                        let channels = message.guild.channels.cache.filter(
                            c =>
                                !c.permissionOverwrites.cache.has(role) ||
                                (c.permissionOverwrites.cache.has(role) &&
                                    !c.permissionOverwrites.cache.get(role).deny.toArray().includes("VIEW_CHANNEL"))
                        );
                        if (!channels || channels.size == 0) {
                            return menu?.reply({
                                content: eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable93"]),
                            });
                        }
