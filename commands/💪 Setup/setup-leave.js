        ...
        try {
            ...
            async function first_layer() {
                ...
                let MenuEmbed = new EmbedBuilder()
                    .setColor(es.color)
                    .setAuthor({ name: "Leave Setup", iconURL: "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/samsung/306/waving-hand_1f44b?.png", url: "https://discord.gg/milrato" })
                                    ...
                                    case `${client.settings.get(message.guild.id, "leave.channel") == "nochannel" ? "Set Channel" : "Overwrite Channel"}`:
                                        {
                                            tempmsg = await message.reply({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        .setTitle(
                                                            eval(client.la[ls]["cmds"]["setup"]["setup-leave"]["variable7"])
                                                        )
                                                        .setColor(es.color)
                                                        .setDescription(
                                                            eval(client.la[ls]["cmds"]["setup"]["setup-leave"]["variable8"])
                                                        )
                                                        ...
                                                        return message.reply({
                                                            embeds: [
                                                                new EmbedBuilder()
                                                                    .setTitle(
                                                                        eval(
                                                                            client.la[ls]["cmds"]["setup"]["setup-leave"][
                                                                                "variable9"
                                                                            ]
                                                                        )
                                                                    )
                                    ...
                                    case `Disable Leave`:
                                        {
                                            ...
                                            return reaction.message.reply({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        .setTitle(
                                                            eval(client.la[ls]["cmds"]["setup"]["setup-leave"]["variable13"])
                                                        )
                                                        .setColor(es.color)
                                                        .setDescription(
                                                    ...
                                                    case `${client.settings.get(message.guild.id, "leave.frame") ? "Disable" : "Enable"} Frame`:
                                                        {
                                                            ...
                                                            client.settings.set(
                                                                message.guild.id,
                                                                !client.settings.get(message.guild.id, "leave.frame"),
                                                                "leave.frame"
                                                            );
                                                            return message.reply({
                                                                embeds: [
                                                    ...
                                                    case `${client.settings.get(message.guild.id, "leave.membercount") ? "Disable" : "Enable"} Member Count`:
                                                        {
                                                            ...
                                                            client.settings.set(
                                                                message.guild.id,
                                                                !client.settings.get(message.guild.id, "leave.membercount"),
                                                                "leave.membercount"
                                                            );
                                                            return message.reply({
                                                                embeds: [
                                                    ...
                                                    case `${client.settings.get(message.guild.id, "leave.servername") ? "Disable" : "Enable"} Server Name`:
                                                        {
                                                            ...
                                                            client.settings.set(
                                                                message.guild.id,
                                                                !client.settings.get(message.guild.id, "leave.servername"),
                                                                "leave.servername"
                                                            );
                                                            return message.reply({
                                                                embeds: [
                                                    ...
                                                    case `${client.settings.get(message.guild.id, "leave.pb") ? "Disable" : "Enable"} User-Avatar`:
                                                        {
                                                            ...
                                                            client.settings.set(
                                                                message.guild.id,
                                                                !client.settings.get(message.guild.id, "leave.pb"),
                                                                "leave.pb"
                                                            );
                                                            return message.reply({
                                                                embeds: [
                                    ...
                                    case `Edit the Message`:
                                        {
                                            tempmsg = await message.reply({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        .setTitle(
                                                            eval(client.la[ls]["cmds"]["setup"]["setup-leave"]["variable64"])
                                                        )
                                                        .setColor(es.color)
                                                        .setDescription(
                                                            eval(client.la[ls]["cmds"]["setup"]["setup-leave"]["variable65"])
                                                        )
                                                        .setFooter(client.getFooter(es)),
                                                ],
                                            });
                                    ...
                                    case `${client.settings.get(message.guild.id, "leave.invite") ? "Disable InviteInformation" : "Enable Invite Information"}`:
                                        {
                                            client.settings.set(
                                                message.guild.id,
                                                !client.settings.get(message.guild.id, "leave.invite"),
                                                "leave.invite"
                                            );
                                            return reaction.message.reply({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        .setTitle(
                                                            eval(client.la[ls]["cmds"]["setup"]["setup-leave"]["variable70"])
                                                        )
                                                        .setColor(es.color)
                                                        .setDescription(
                                    ...
                                    case `${!client.settings.get(message.guild.id, "leave.dm") ? "Enable Dm Messages" : "Disable Dm Messages"}`:
                                        {
                                            ...
                                            return message.reply({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        .setTitle(
                                                            eval(client.la[ls]["cmds"]["setup"]["setup-leave"]["variable76"])
                                                        )
                                                        .setColor(es.color)
                                                        .setFooter(client.getFooter(es)),
                                                ],
                                                            ...
                                                            return message.reply({
                                                                embeds: [
                                                                    new EmbedBuilder()
                                                                        ...
                                                                        .setColor(es.color)
                                                                        .setDescription(
                                                                            `I will be using ${client.settings.get(message.guild.id, "leave.customdm") === "no" ? "an Auto generated Image with User Data" : "Your defined, custom Image"}\n\nIf Someone joins this Server, a message **with an image** will be sent into DMS`.substring(
                                                                                0,
                                                                                2048
                                                                            )
                                                                        )
                                                    ...
                                                    case `${client.settings.get(message.guild.id, "leave.framedm") ? "Disable" : "Enable"} Frame`:
                                                        {
                                                            ...
                                                            client.settings.set(
                                                                message.guild.id,
                                                                !client.settings.get(message.guild.id, "leave.framedm"),
                                                                "leave.framedm"
                                                            );
                                                            return message.reply({
                                                                embeds: [
                                                    ...
                                                    case `${client.settings.get(message.guild.id, "leave.servernamedm") ? "Disable" : "Enable"} Server Name`:
                                                        {
                                                            ...
                                                            client.settings.set(
                                                                message.guild.id,
                                                                !client.settings.get(message.guild.id, "leave.servernamedm"),
                                                                "leave.servernamedm"
                                                            );
                                                            return message.reply({
                                                                embeds: [
                                                    ...
                                                    case `${client.settings.get(message.guild.id, "leave.pbdm") ? "Disable" : "Enable"} User-Avatar`:
                                                        {
                                                            ...
                                                            client.settings.set(
                                                                message.guild.id,
                                                                !client.settings.get(message.guild.id, "leave.pbdm"),
                                                                "leave.pbdm"
                                                            );
                                                            return message.reply({
                                                                embeds: [
                                    ...
                                    case `${client.settings.get(message.guild.id, "leave.invitedm") ? "Disable InviteInformation" : "Enable Invite Information"}`:
                                        {
                                            client.settings.set(
                                                message.guild.id,
                                                !client.settings.get(message.guild.id, "leave.invitedm"),
                                                "leave.invitedm"
                                            );
                                            return reaction.message.reply({
                                                embeds: [
