      ...
      */
            ...
            async function first_layer() {
                ...
                let MenuEmbed = new EmbedBuilder()
                    .setColor(es.color)
                    .setAuthor({ name: "Mute System", iconURL: "https://cdn.discordapp.com/emojis/771804364582420532.gif?size=96", url: "https://discord.gg/milrato" })
                            ...
                            var tempmsg = await message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setColor(es.color)
                                        .setDescription(
                                            "Recommneded is: `10min`, but you can send anything you want, as long as it's less than `1Week`!\nTo send multiple do this: `1hour+5min`"
                                        )
                                        .setFooter(client.getFooter(es)),
                                ],
                            });
                                    ...
                                    return message.reply({
                                        embeds: [
                                            new EmbedBuilder()
                                                ...
                                                .setColor(es.color)
                                                .setDescription(
                                                    `When someone get's muted and no time get's added this will be used!`.substring(
                                                        0,
                                                        2048
                                                    )
                                                )
