...
`
            ...
            function ask_emoji() {
                ...
                message.reply({ embeds: [rermbed] }).then(msg => {
                    msg.awaitReactions({ filter: (reaction, user) => user.id == message.author.id, max: 1, time: 180e3 })
                        .then(collected => {
                            if (collected.first().emoji?.id && collected.first().emoji?.id.length > 2) {
                                ...
                                if (collected.first().emoji?.animated)
                                    object2.Emojimsg =
                                        "<" + "a:" + collected.first().emoji?.name + ":" + collected.first().emoji?.id + ">";
                                else
                                    object2.Emojimsg =
                                        "<" + ":" + collected.first().emoji?.name + ":" + collected.first().emoji?.id + ">";
                                return ask_role();
                            ...
                            message.reply({
                                content: eval(client.la[ls]["cmds"]["setup"]["setup-reactionrole"]["variable5"]),
                            });
                            return finished();
                        })
                        .catch(() => {
                            if (!cancel) {
                                message.reply({
                                    content: eval(client.la[ls]["cmds"]["setup"]["setup-reactionrole"]["variable6"]),
                                });
                                return finished();
                            }
                        });
                    msg.channel
                        .awaitMessages({ filter: m => m.author.id === message.author.id, max: 1, time: 180e3 })
                        .then(collected => {
                        ...
                        .catch(() => {
                            if (!cancel) {
                                message.reply({
                                    content: eval(client.la[ls]["cmds"]["setup"]["setup-reactionrole"]["variable7"]),
                                });
                                return finished();
                            }
                        });
                    ...
                    message.reply({ embeds: [rermbed] }).then(msg => {
                        msg.channel
                            ...
                            .then(collected => {
                                ...
                                if (!role)
                                    message.reply({
                                        content: eval(client.la[ls]["cmds"]["setup"]["setup-reactionrole"]["variable9"]),
                                    });
                                if (role) {
                                ...
                                message.reply({
                                    content: eval(client.la[ls]["cmds"]["setup"]["setup-reactionrole"]["variable10"]),
                                });
                                return finished();
                            })
                            .catch(e => {
                                ...
                                message.reply({
                                    content: eval(client.la[ls]["cmds"]["setup"]["setup-reactionrole"]["variable11"]),
                                });
                                return finished();
                            });
                    });
                    ...
                    .reply({
                        embeds: [
                            new EmbedBuilder()
                                ...
                                .setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-reactionrole"]["variable13"])),
                        ],
                    })
                    .then(msg => {
                        var emojis2 = ["1️⃣", "2️⃣"];
                        ...
                        msg.awaitReactions({
                            filter: (reaction, user) =>
                                user.id === message.author.id && emojis2.includes(reaction.emoji?.name),
                            max: 1,
                            time: 120000,
                            erros: ["time"],
                        })
                            .then(collected => {
                                switch (collected.first().emoji?.name) {
                                    ...
                                    default:
                                        message.reply({
                                            content: eval(
                                                client.la[ls]["cmds"]["setup"]["setup-reactionrole"]["variable14"]
                                            ),
                                        });
                                        break;
                                }
                                ...
                                var thisembed = new EmbedBuilder()
                                    ...
                                    .setDescription(
                                        eval(client.la[ls]["cmds"]["setup"]["setup-reactionrole"]["variable16"])
                                    );
                                message
                                    .reply({
                                                    ...
                                                    .reply({
                                                        embeds: [
                                                            new EmbedBuilder()
                                                                ...
                                                                .setTitle(
                                                                    eval(
                                                                        client.la[ls]["cmds"]["setup"]["setup-reactionrole"][
                                                                            "variable17"
                                                                        ]
                                                                    )
                                                                )
                                                        ...
                                                        msg.channel
                                                            ...
                                                            .then(collected => {
                                                                if (
                                                                    ...
                                                                    channel
                                                                        .send({ embeds: [embed.setDescription(buffer)] })
                                                                        .then(msg => {
                                                                            for (
                                                                                var i = 0;
