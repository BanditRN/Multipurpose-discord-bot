        ...
        try {
            ...
            async function first_layer() {
                ...
                let MenuEmbed = new EmbedBuilder()
                    .setColor(es.color)
                    .setAuthor({ name: "Twitch-Logger", iconURL: "https://cdn.discordapp.com/emojis/720391959746969710.gif?size=160", url: "https://discord.gg/milrato" })
                    ...
                    case "Remove Channel":
                        {
                            ...
                            let MenuEmbed = new EmbedBuilder()
                                .setColor(es.color)
                                .setAuthor({ name: "Twitch-Poster", iconURL: "https://cdn.discordapp.com/emojis/720391959746969710.gif?size=160", url: "https://discord.gg/milrato" })
