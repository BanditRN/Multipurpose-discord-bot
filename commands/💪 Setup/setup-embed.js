            ...
            var tempmsg = await message.reply({
                ...
                embeds: [
                    new EmbedBuilder()
                        ...
                        .setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-embed"]["variable2"]))
                ...
                if (button?.user.id === cmduser.id) {
                    ...
                    if (button?.customId == "1") {
                            ...
                            .then(collected => {
                                    ...
                                    return message.reply({
                                        embeds: [
                                            new EmbedBuilder()
                                                ...
                                                .setDescription(
                                                    eval(client.la[ls]["cmds"]["setup"]["setup-embed"]["variable8"])
                                                )
                                                .setFooter(client.getFooter(es)),
                                        ],
                                    });
                                try {
                                    ...
                                    try {
                                        ...
                                        if (!newcolor)
                                            throw {
                                                message: "Invalid Color Added, make sure to stick to the Example-Rules",
                                            };
                                    } catch (e) {
                                        return message.reply({
                                            embeds: [
                                    ...
                                    return message.reply({
                                        embeds: [
                                            new EmbedBuilder()
                                                ...
                                                .setColor(es.wrongcolor)
                                                .setDescription(
                                                    eval(client.la[ls]["cmds"]["setup"]["setup-embed"]["variable13"])
                                                )
                                                .setFooter(client.getFooter(es)),
                                        ],
                                    });
                                            ...
                                            return message.reply({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setColor(es.wrongcolor)
                                                        .setDescription(
                                                            eval(client.la[ls]["cmds"]["setup"]["setup-embed"]["variable19"])
                                                        )
                                                        .setFooter(client.getFooter(es)),
                                                ],
                                            });
                                    ...
                                    return message.reply({
                                        embeds: [
                                            new EmbedBuilder()
                                                ...
                                                .setColor(es.wrongcolor)
                                                .setDescription(
                                                    eval(client.la[ls]["cmds"]["setup"]["setup-embed"]["variable29"])
                                                )
                                                .setFooter(client.getFooter(es)),
                                        ],
                                    });
                        ...
                        try {
                            client.settings.set(
                                message.guild.id,
                                !client.settings.get(message.guild.id, "embed.thumb"),
                                "embed.thumb"
                            );
                            es = client.settings.get(message.guild.id, "embed");
                            return message.reply({
