        ...
        try {
            ...
            async function second_layer(SetupNumber, menuoptiondata) {
                ...
                let Selection = new StringSelectMenuBuilder()
                    ...
                    .setMinValues(1)
                    .setPlaceholder(
                        `Click me to manage the ${SetupNumber} Roster System!\n\n**You've picked:**\n> ${menuoptiondata.value}`
                    )
                    .addOptions(
                ...
                let MenuEmbed = new EmbedBuilder()
                    .setColor(es.color)
                    .setAuthor({ name: SetupNumber + " Server Roster Setup", iconURL: "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/facebook/65/page-with-curl_1f4c3.png", url: "https://discord.gg/milrato" })
                                            ...
                                            return message.reply({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setColor(es.color)
                                                        .setDescription(
                                                            `To add Roles to the Roster type: \`${prefix}setup-roster\``.substring(
                                                                0,
                                                                2048
                                                            )
                                                        )
                                            ...
                                            return message.reply({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setDescription(
                                                            eval(
                                                                client.la[ls]["cmds"]["setup"]["setup-roster"]["variable20"]
                                                            )
                                                        )
                                                        .setFooter(client.getFooter(es)),
                                                ],
                                            ...
                                            return message.reply({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setDescription(
                                                            eval(
                                                                client.la[ls]["cmds"]["setup"]["setup-roster"]["variable16"]
                                                            )
                                                        )
                                                        .setFooter(client.getFooter(es)),
                                                ],
                                            ...
                                            return message.reply({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setDescription(
                                                            eval(
                                                                client.la[ls]["cmds"]["setup"]["setup-roster"]["variable18"]
                                                            )
                                                        )
                                                        .setColor(es.color)
                                                        .setFooter(client.getFooter(es)),
                                            ...
                                            return message.reply({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setDescription(
                                                            eval(
                                                                client.la[ls]["cmds"]["setup"]["setup-roster"]["variable29"]
                                                            )
                                                        )
                                                        .setFooter(client.getFooter(es)),
                                                ],
                                            ...
                                            return message.reply({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setDescription(
                                                            eval(
                                                                client.la[ls]["cmds"]["setup"]["setup-roster"]["variable25"]
                                                            )
                                                        )
                                                        .setFooter(client.getFooter(es)),
                                                ],
                                            ...
                                            return message.reply({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setDescription(
                                                            eval(
                                                                client.la[ls]["cmds"]["setup"]["setup-roster"]["variable27"]
                                                            )
                                                        )
                                                        .setColor(es.color)
                                                        .setFooter(client.getFooter(es)),
                                            ...
                                            return message.reply({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setDescription(
                                                            eval(
                                                                client.la[ls]["cmds"]["setup"]["setup-roster"]["variable49"]
                                                            )
                                                        )
                                                        .setFooter(client.getFooter(es)),
                                                ],
                    ...
                    case "Edit Roster Style":
                        {
                            ...
                            try {
                                for (const emoji of ["1️⃣", "2️⃣", "3️⃣", "4️⃣", "5️⃣", "6️⃣", "7️⃣"]) tempmsg.react(emoji);
                            } catch (e) {
                                console.log(e.stack ? String(e.stack).grey : String(e).grey);
                            }
                            await tempmsg
                                            ...
                                            return message.reply({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setDescription(
                                                            eval(
                                                                client.la[ls]["cmds"]["setup"]["setup-roster"]["variable55"]
                                                            )
                                                        )
                                                        .setFooter(client.getFooter(es)),
                                                ],
                                            ...
                                            return message.reply({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setDescription(
                                                            eval(
                                                                client.la[ls]["cmds"]["setup"]["setup-roster"]["variable61"]
                                                            )
                                                        )
                                                        .setFooter(client.getFooter(es)),
                                                ],
                    ...
                    case `${thedb?.get(message.guild.id, pre + ".showallroles") ? "Cut Members off" : "Show all members"}`:
                        {
                            thedb?.set(
                                message.guild.id,
                                !thedb?.get(message.guild.id, pre + ".showallroles"),
                                pre + ".showallroles"
                            );
                            edit_Roster_msg(client, message.guild, thedb, pre);
                            return message.reply({
