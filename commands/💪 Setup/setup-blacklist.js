...
var { databasing, swap_pages, swap_pages2 } = require(`${process.cwd()}/handlers/functions`);
        ...
        try {
            ...
            async function first_layer() {
                ...
                let MenuEmbed = new EmbedBuilder()
                    .setColor(es.color)
                    .setAuthor({ name: "Setup Blacklist", iconURL: "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/joypixels/291/stop-sign_1f6d1.png", url: "https://discord.gg/milrato" })
                    ...
                    case "Add Blacklisted-Word":
                        {
                            ...
                            await tempmsg.channel
                                ...
                                .then(collected => {
                                    ...
                                    if (message.content) {
                                        try {
                                            var blacklistedwords = message.content
                                                .split(",")
                                                .filter(Boolean)
                                            ...
                                            for (const blacklistword of blacklistedwords) {
                                                if (
                                                    client.blacklist.get(message.guild.id, "words").includes(blacklistword)
                                                ) {
                                            ...
                                            return message.reply({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        .setTitle(
                                                            eval(
                                                                client.la[ls]["cmds"]["setup"]["setup-blacklist"][
                                                                    "variable7"
                                                                ]
                                                            )
                                                        )
                            ...
                            var tempmsg = await message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setColor(es.color)
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["setup"]["setup-blacklist"]["variable13"])
                                        )
                                        .setFooter(client.getFooter(es)),
                                ],
                            });
                    ...
                    case "Show Settings":
                        {
                            return swap_pages(
                                ...
                                message,
                                `${client.blacklist
                                    .get(message.guild.id, "words")
                                    .map(word => `\`${word}\``)
                                    .join(", ")
                                    .split("`")
                                    .join("`")}`,
                                `${message.guild.name} | Blacklisted Words`
                            );
                        }
                        break;
