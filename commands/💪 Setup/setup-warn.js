        ...
        try {
            ...
            async function first_layer() {
                ...
                let MenuEmbed = new EmbedBuilder()
                    .setColor(es.color)
                    .setAuthor({ name: "Warn Setup", iconURL: "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/apple/285/prohibited_1f6ab?.png", url: "https://discord.gg/milrato" })
                            ...
                            msg.channel
                                ...
                                .then(collected => {
                                        ...
                                        return message.reply({
                                            embeds: [
                                                new EmbedBuilder()
                                                    ...
                                                    .setColor(es.wrongcolor)
                                                    .setDescription(
                                                        `You can't add 2 Roles at the Same time`.substring(0, 2000)
                                                    )
                                                    .setFooter(client.getFooter(es)),
                                            ],
                                        });
                                    client.settings.push(
                                        message.guild.id,
                                        { warncount: Number(amount), roleid: role.id },
                                        "warnsettings.roles"
                                    );
                                    return message.reply({
                                        embeds: [
                                        ...
                                        return message.reply({
                                            embeds: [
                                                new EmbedBuilder()
                                                    ...
                                                    .setColor(es.wrongcolor)
                                                    .setDescription(
                                                        `You can't remove a Setting which does not exist`.substring(0, 2000)
                                                    )
                                                    .setFooter(client.getFooter(es)),
                                            ],
                                        });
