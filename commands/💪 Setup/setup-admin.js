                                            ...
                                            return message.reply({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setColor(es.color)
                                                        .setDescription(
                                                            `Everyone with one of those Roles:\n<@&${client.settings.get(message.guild.id, "adminroles").join(">\n<@&")}>\nis now able to use the Admin Commands`.substring(
                                                                0,
                                                                2048
                                                            )
                                                        )
                                            ...
                                            return message.reply({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setColor(es.wrongcolor)
                                                        .setDescription(
                                                            eval(client.la[ls]["cmds"]["setup"]["setup-admin"]["variable47"])
                                                        )
                                                        .setFooter(client.getFooter(es)),
                                                ],
                                            });
                                            ...
                                            return message.reply({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setColor(es.wrongcolor)
                                                        .setDescription(
                                                            eval(client.la[ls]["cmds"]["setup"]["setup-admin"]["variable52"])
                                                        )
                                                        .setFooter(client.getFooter(es)),
                                                ],
                                            });
                    ...
                    case "Show Settings":
                        {
                            ...
                            var embed = new EmbedBuilder()
                                ...
                                .setColor(es.color)
                                .setDescription(
                                    `**General Admin Roles:**\n${client.settings.get(message.guild.id, "adminroles").length > 0 ? `<@&${client.settings.get(message.guild.id, "adminroles").join(">, <@&")}>` : "No General Admin Roles Setup yet"}`.substring(
                                        0,
                                        2048
                                    )
                                )
                                ...
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            `
              ${client.commands
                  ?.filter?.(cmd => cmd.category?.includes?.("Admin"))
                  ?.map?.(cmd => `\`${cmd.name}\``)
                  .join(" | ")}
              ...
              *Enter one of those Commands!*`
                            ...
                            await tempmsg.channel
                                ...
                                .then(async collected => {
                                    ...
                                    const cmd =
                                        client.commands.get(com.toLowerCase()) ||
                                        client.commands.get(client.aliases.get(com.toLowerCase()));
                                    if (!cmd)
                                        return message.reply({
                                            embeds: [
                                                new EmbedBuilder()
                                            ...
                                            case "Add Role":
                                                {
                                                    ...
                                                    await tempmsg.channel
                                                        ...
                                                        .then(collected => {
                                                            ...
                                                            if (role) {
                                                                var adminroles = client.settings.get(
                                                                    message.guild.id,
                                                                    `cmdadminroles.${thecmd}`
                                                                );
                                                                if (adminroles.includes(role.id))
                                                                    return message.reply({
                                                                        embeds: [
                                                                    ...
                                                                    return message.reply({
                                                                        embeds: [
                                                                            new EmbedBuilder()
                                                                                ...
                                                                                .setColor(es.color)
                                                                                .setDescription(
                                                                                    `Everyone with one of those Roles/Users:\n${cmdrole.join("\n")}\nis now able to use the ${thecmd} Admin Commands`.substring(
                                                                                        0,
                                                                                        2048
                                                                                    )
                                                                                )
