...
module.exports = {
    ...
    description:
        "Define Key Word messages, so that if someone sends a Message containing that Keyword, the Bot will responde with your defined MESSAGE",
        ...
        try {
            ...
            async function first_layer() {
                ...
                let MenuEmbed = new EmbedBuilder()
                    .setColor(es.color)
                    .setAuthor({ name: "Keyword Setup", iconURL: "https://images-ext-1.discordapp.net/external/HF-XNy3iUP4D95zv2fuTUy1csYWuNa5IZj2HSCSkvhs/https/emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/google/298/flexed-biceps_1f4aa.png", url: "https://discord.gg/milrato" })
                                        ...
                                        tempmsg = await message.reply({
                                            embeds: [
                                                new EmbedBuilder()
                                                    ...
                                                    .setColor(es.color)
                                                    .setDescription(
                                                        eval(client.la[ls]["cmds"]["setup"]["setup-keyword"]["variable9"])
                                                    )
                                                    .setFooter(client.getFooter(es)),
                                            ],
                                        });
                                                        ...
                                                        .then(async collected => {
                                                            ...
                                                            if (channel) {
                                                                for (const ch of collected
                                                                    .first()
                                                                    .mentions.channels.map(
                                                                        this_Code_is_by_Tomato_6966 =>
                                                                            this_Code_is_by_Tomato_6966
                                                                    )) {
                                                                        ...
                                                                        await ttempmsg
                                                                            ...
                                                                            .then(collected => {
                                                                                ...
                                                                                if (reaction) {
                                                                                    ...
                                                                                    return message.reply(
                                                                                        "you didn't ping a valid Channel"
                                                                                    );
                                                                                }
                                                                            })
                                                                            .catch(e => {
