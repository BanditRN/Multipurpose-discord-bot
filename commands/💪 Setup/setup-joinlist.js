                ...
                return message.reply({
                    embeds: [
                        ...
                        new EmbedBuilder()
                            ...
                            .setDescription(
                                `> \`${prefix}joinlist username_contain kick <Word_to_contain>\`` +
                        ...
                        new EmbedBuilder()
                            ...
                            .setDescription(
                                `> \`${prefix}joinlist username_equal kick <Name_to_be_equal>\`` +
                        ...
                        new EmbedBuilder()
                            ...
                            .setDescription(
                                `> \`${prefix}joinlist userid kick <User_ID>\`` +
                        ...
                        new EmbedBuilder()
                            ...
                            .setDescription(
                                `> \`${prefix}joinlist server_in_common kick <Server_ID>\`` +
                        ...
                        new EmbedBuilder()
                            ...
                            .setDescription(
                                `> \`${prefix}joinlist server_not_in_common kick <Server_ID>\`` +
                        ...
                        new EmbedBuilder()
                            ...
                            .setDescription(
                                `> \`${prefix}joinlist noavatar kick <enable/disable>\`` +
          ...
          */
            ...
            //add
                    ...
                    case 0:
                        {
                            ...
                            if (action == "setnickname") {
                                ...
                                if (!nickname || nickname.length > 32)
                                    return message.reply(
                                        "For the action `setnickname` a Nickname must be provided at the very end (after the data), which is less than 32 Characters, insert `{random}`, so that the nickname will randomly be choosen!"
                                    );
                                ...
                                if (!time || time < 10 || time == "NAN")
                                    return message.reply(
                                        "For the action `timeout` a timeout duration must be provided at the very end (after the data), For example: 1day, if you want multiple timeouts than do: 1day+10min"
                                    );
                    ...
                    case 3:
                        {
                            ...
                            if (isValidSnowflakeId(data)) {
                                return message.reply(
                                    `Valid Datas for \`${action}\` are \`GUILD_IDS\`\nThe Users are not allowed to be in the provided Guild ID!\nA Guildid is between 17 and 20 characters long!`
                                );
                            }
                    ...
                    case 5:
                        {
                            ...
                            if (!validdatas.includes(data)) {
                                return message.reply(
                                    `Valid Datas for \`${action}\` are ${validdatas.map(d => `\`${d}\``).join(", ")}`
                                );
                            }
                ...
                message.channel.send(
                    `**GENERAL MESSAGE:** Successfully added \`${data}\` to the action \`${action}\` & to the Type: \`${type}\``
                );
            }
        } catch (e) {
