        ...
        try {
            ...
            async function first_layer() {
                ...
                let MenuEmbed = new EmbedBuilder()
                    .setColor(es.color)
                    .setAuthor({ name: "Auto Embed Setup", iconURL: "https://cdn.discordapp.com/emojis/850829013438300221.png?size=96", url: "https://discord.gg/milrato" })
                            ...
                            message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setColor(es.color)
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["setup"]["setup-autoembed"]["variable24"])
                                        )
                                        .setFooter(client.getFooter(es)),
                                ],
                            });
