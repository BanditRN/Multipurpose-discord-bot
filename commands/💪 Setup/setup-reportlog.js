        ...
        try {
            ...
            async function first_layer() {
                ...
                let MenuEmbed = new EmbedBuilder()
                    .setColor(es.color)
                    .setAuthor({ name: "Report Log Setup", iconURL: "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/apple/285/bookmark_1f516.png", url: "https://discord.gg/milrato" })
                                        ...
                                        return message.reply({
                                            embeds: [
                                                new EmbedBuilder()
                                                    ...
                                                    .setColor(es.color)
                                                    .setDescription(
                                                        `If someone executes the Report Command, a Log Information will be sent in that Channel`.substring(
                                                            0,
                                                            2048
                                                        )
                                                    )
