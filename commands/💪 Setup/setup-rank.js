                                    ...
                                    return message.reply({
                                        embeds: [
                                            new EmbedBuilder()
                                                ...
                                                .setColor(es.wrongcolor)
                                                .setDescription(
                                                    eval(client.la[ls]["cmds"]["setup"]["setup-rank"]["variable16"])
                                                )
                                                .setFooter(client.getFooter(es)),
                                        ],
                                    });
                            ...
                            await tempmsg.channel
                                ...
                                .then(collected => {
                                    ...
                                    var Role =
                                        ...
                                        message.guild.roles.cache.get(arggs[1]);
                                    try {
                                            ...
                                            return message.reply({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setColor(es.color)
                                                        .setDescription(
                                                            `To add it back type: \`${prefix}setup-rank\` --> 4️⃣ -->  \`${parseInt(arggs[0])} @${Role.name}\``
                                                        )
                                                        .setFooter(client.getFooter(es)),
                                                ],
                                            });
                                        ...
                                        return message.reply({
                                            embeds: [
                                                new EmbedBuilder()
                                                    ...
                                                    .setColor(es.color)
                                                    .setDescription(
                                                        `To remove it type: \`${prefix}setup-rank\` --> 4️⃣ -->  \`${parseInt(arggs[0])}\``
                                                    )
                                                    .setFooter(client.getFooter(es)),
                                            ],
                                        });
