        ...
        try {
            ...
            async function first_layer() {
                let menuoptions = [
                    {
                        ...
                        emoji: `${client.settings.get(message.guild.id, `antilink.enabled`) ? allEmojis.msg.ERROR : allEmojis.msg.SUCCESS}`,
                    },
                    {
                        value: "Settings",
                ...
                let MenuEmbed = new EmbedBuilder()
                    .setColor(es.color)
                    .setAuthor({ name: "Anti-Links System Setup", iconURL: "https://cdn.discordapp.com/emojis/858405056238714930.gif?v=1", url: "https://discord.gg/milrato" })
                ...
                collector.on("collect", menu => {
                    if (menu?.user.id === cmduser.id) {
                        ...
                        if (menu?.values[0] == "Cancel")
                            return menu?.reply({
                                content: eval(client.la[ls]["cmds"]["setup"]["setup-antilink"]["variable2"]),
                            });
                        menu?.deferUpdate();
                        used1 = true;
                    ...
                    case 0:
                        {
                            client.settings.set(
                                message.guild.id,
                                !client.settings.get(message.guild.id, `antilink.enabled`),
                                `antilink.enabled`
                            );
                                            ...
                                            return message.reply({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        .setTitle(
                                                            eval(
                                                                client.la[ls]["cmds"]["setup"]["setup-antilink"]["variable7"]
                                                            )
                                                        )
                                            ...
                                            return message.reply({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        .setTitle(
                                                            eval(
                                                                client.la[ls]["cmds"]["setup"]["setup-antilink"]["variable8"]
                                                            )
                                                        )
                                                        .setColor(es.color)
                                                        .setDescription(
                                            ...
                                            return message.reply({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        .setTitle(
                                                            eval(
                                                                client.la[ls]["cmds"]["setup"]["setup-antilink"]["variable9"]
                                                            )
                                                        )
                                                        .setColor(es.wrongcolor)
                                                        .setDescription(
