...
module.exports = {
    ...
    run: async (client, message, args, cmduser, text, prefix) => {
        ...
        try {
            let NumberEmojis = emoji.number_emojis;
            first_layer();
                                        ...
                                        return message.reply({
                                            embeds: [
                                                new EmbedBuilder()
                                                    ...
                                                    .setDescription(
                                                        eval(client.la[ls]["cmds"]["setup"]["setup-youtube"]["variable7"])
                                                    )
                                                    .setColor(es.color)
                                                    .setFooter(client.getFooter(es)),
                                            ],
                                ...
                                .then(async collected => {
                                    ...
                                    if (msg && msg.content) {
                                        if (
                                            ...
                                            !msg.content.toLowerCase().includes("youtube") &&
                                        ...
                                        return message.reply({
                                            embeds: [
                                                new EmbedBuilder()
                                                    ...
                                                    .setDescription(
                                                        eval(client.la[ls]["cmds"]["setup"]["setup-youtube"]["variable13"])
                                                    )
                                                    .setColor(es.color)
                                                    .setFooter(client.getFooter(es)),
                                            ],
                    ...
                    case "Remove Youtube Channel":
                        {
                            ...
                            let menuoptions = channels.map((data, index) => {
                                ...
                                Obj.description =
                                    `${data.replace("https://", "").replace("http://", "").replace("www.", "")}`.substring(
                                        0,
                                        50
                                    );
                                return Obj;
                                    ...
                                    tempmsg = await message.reply({
                                        embeds: [
                                            new EmbedBuilder()
                                                ...
                                                .setColor(es.color)
                                                .setDescription(
                                                    `**CURRENT MESSAGE:**\n> ${client.youtube_log.get(channel, "message")}`.substring(
                                                        0,
                                                        2048
                                                    )
                                                )
