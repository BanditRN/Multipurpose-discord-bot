...
module.exports = {
    ...
    run: async (client, message, args, cmduser, text, prefix) => {
            ...
            async function first_layer() {
                let menuoptions = [
                    ...
                    },
                    {
                        ...
                        emoji: allEmojis.numberEmojis[1],
                    },
                    {
                        value: "Deny Text",
                        description: `Define the Deny Text`,
                        emoji: allEmojis.numberEmojis[2],
                    },
                    {
                        value: "Maybe Text",
                        description: `Define the Maybe Text`,
                        emoji: allEmojis.numberEmojis[3],
                    },
                    {
                        value: "Status Text",
                        description: `Define the Status Text`,
                        emoji: allEmojis.numberEmojis[4],
                    },
                    {
                        value: "Soon Text",
                        description: `Define the Soon Text`,
                        emoji: allEmojis.numberEmojis[5],
                    },
                    {
                        value: "Footer Text",
                        description: `Define the Footer Text`,
                        emoji: allEmojis.numberEmojis[6],
                    },
                    {
                        value: "Upvote Emoji",
                ...
                let MenuEmbed = new EmbedBuilder()
                    .setColor(es.color)
                    .setAuthor({ name: "Suggestion System", iconURL: "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/282/light-bulb_1f4a1.png", url: "https://discord.gg/milrato" })
      ...
      client.settings.ensure(message.guild.id, {
        suggest: {
          channel: "",
          approvemsg: `${allEmojis.msg.SUCCESS} Accepted Idea! Expect this soon.`,
                            ...
                            var tempmsg = await message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setColor(es.color)
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["setup"]["setup-suggestion"]["variable5"])
                                        )
                            ...
                            var tempmsg = await message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setColor(es.color)
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["setup"]["setup-suggestion"]["variable11"])
                                        )
                                        .setFooter(client.getFooter(es)),
                                ],
                            });
                            ...
                            var tempmsg = await message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setColor(es.color)
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["setup"]["setup-suggestion"]["variable17"])
                                        )
                                        .setFooter(client.getFooter(es)),
                                ],
                            });
                            ...
                            var tempmsg = await message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setColor(es.color)
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["setup"]["setup-suggestion"]["variable23"])
                                        )
                                        .setFooter(client.getFooter(es)),
                                ],
                            });
                            ...
                            var tempmsg = await message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setColor(es.color)
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["setup"]["setup-suggestion"]["variable29"])
                                        )
                                        .setFooter(client.getFooter(es)),
                                ],
                            });
                            ...
                            var tempmsg = await message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setColor(es.color)
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["setup"]["setup-suggestion"]["variable35"])
                                        )
                                        .setFooter(client.getFooter(es)),
                                ],
                            });
                            ...
                            var tempmsg = await message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setColor(es.color)
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["setup"]["setup-suggestion"]["variable41"])
                                        )
                                        .setFooter(client.getFooter(es)),
                                ],
                            });
                            ...
                            var tempmsg = await message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setColor(es.color)
                                        .setDescription(
                                            eval(client.la[ls]["cmds"]["setup"]["setup-suggestion"]["variable52"])
                                        )
                                        .setFooter(client.getFooter(es)),
                                ],
                            });
