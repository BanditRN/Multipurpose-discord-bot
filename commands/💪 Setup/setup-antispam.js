        ...
        try {
            ...
            async function first_layer() {
                ...
                let MenuEmbed = new EmbedBuilder()
                    .setColor(es.color)
                    .setAuthor({ name: "Anti-Spam System Setup", iconURL: "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/282/a-button-blood-type_1f170-fe0f.png", url: "https://discord.gg/milrato" })
                            ...
                            let tempmsg = await message.reply({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setColor(es.color)
                                        .setDescription(
                                            `The Current limit is: \`${client.settings.get(message.guild.id, "antispam.limit")} Messages / 10 Seconds\`\n\nOur Suggestion is to keep it between 5 and 20\n\nPlease just send the NUMBER`
                                        )
                                            ...
                                            return message.reply({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setDescription(
                                                            "Users can't send more messages then 30 in under 10 Seconds..."
                                                        )
                                                        .setFooter(client.getFooter(es)),
                                                ],
                                            });
