    ...
    run: async (client, message, args, cmduser, text, prefix) => {
        ...
        try {
            ...
            var sorted = datas.sort((a, b) => {
                ...
                for (const itemarray in a.items) {
                    switch (itemarray.toLowerCase()) {
                        case "yacht":
                            prizea += a.items[`${itemarray}`] * 75000;
                            break;
                        case "lamborghini":
                            prizea += a.items[`${itemarray}`] * 50000;
                            break;
                        case "car":
                            prizea += a.items[`${itemarray}`] * 6400;
                            break;
                        case "motorbike":
                            prizea += a.items[`${itemarray}`] * 1500;
                            break;
                        case "bicycle":
                            prizea += a.items[`${itemarray}`] * 500;
                            break;

                        case "nike":
                            prizea += a.items[`${itemarray}`] * 300;
                            break;
                        case "tshirt":
                            prizea += a.items[`${itemarray}`] * 60;
                            break;

                        case "mansion":
                            prizea += a.items[`${itemarray}`] * 45000;
                            break;
                        case "house":
                            prizea += a.items[`${itemarray}`] * 8000;
                            break;
                        case "dirthut":
                            prizea += a.items[`${itemarray}`] * 150;
                            break;

                        case "pensil":
                            prizea += a.items[`${itemarray}`] * 20;
                            break;
                        case "pen":
                            prizea += a.items[`${itemarray}`] * 10;
                            break;
                        case "condom":
                            prizea += a.items[`${itemarray}`] * 30;
                            break;
                        case "bottle":
                            prizea += a.items[`${itemarray}`] * 50;
                            break;

                        case "fish":
                            prizea += a.items[`${itemarray}`] * 1000;
                            break;
                        case "hamster":
                            prizea += a.items[`${itemarray}`] * 1500;
                            break;
                        case "dog":
                            prizea += a.items[`${itemarray}`] * 2000;
                            break;
                        case "cat":
                            prizea += a.items[`${itemarray}`] * 2000;
                            break;
                ...
                for (const itemarray in b?.items) {
                    switch (itemarray.toLowerCase()) {
                        case "yacht":
                            prizeb += b?.items[`${itemarray}`] * 75000;
                            break;
                        case "lamborghini":
                            prizeb += b?.items[`${itemarray}`] * 50000;
                            break;
                        case "car":
                            prizeb += b?.items[`${itemarray}`] * 6400;
                            break;
                        case "motorbike":
                            prizeb += b?.items[`${itemarray}`] * 1500;
                            break;
                        case "bicycle":
                            prizeb += b?.items[`${itemarray}`] * 500;
                            break;

                        case "nike":
                            prizeb += b?.items[`${itemarray}`] * 300;
                            break;
                        case "tshirt":
                            prizeb += b?.items[`${itemarray}`] * 60;
                            break;

                        case "mansion":
                            prizeb += b?.items[`${itemarray}`] * 45000;
                            break;
                        case "house":
                            prizeb += b?.items[`${itemarray}`] * 8000;
                            break;
                        case "dirthut":
                            prizeb += b?.items[`${itemarray}`] * 150;
                            break;

                        case "pensil":
                            prizeb += b?.items[`${itemarray}`] * 20;
                            break;
                        case "pen":
                            prizeb += b?.items[`${itemarray}`] * 10;
                            break;
                        case "condom":
                            prizeb += b?.items[`${itemarray}`] * 30;
                            break;
                        case "bottle":
                            prizeb += b?.items[`${itemarray}`] * 50;
                            break;

                        case "fish":
                            prizeb += b?.items[`${itemarray}`] * 1000;
                            break;
                        case "hamster":
                            prizeb += b?.items[`${itemarray}`] * 1500;
                            break;
                        case "dog":
                            prizeb += b?.items[`${itemarray}`] * 2000;
                            break;
                        case "cat":
                            prizeb += b?.items[`${itemarray}`] * 2000;
                            break;
            ...
            const filter = (reaction, user) =>
                (reactionemojis.includes(reaction.emoji?.name) || reactionemojis.includes(reaction.emoji?.name)) &&
