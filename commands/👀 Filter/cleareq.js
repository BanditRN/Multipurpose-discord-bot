            ...
            return message.channel.send({
                embeds: [
                    new EmbedBuilder()
                        ...
                        .addFields({ name: eval(client.la[ls]["cmds"]["filter"]["cleareq"]["variablex_2"]), value: eval(client.la[ls]["cmds"]["filter"]["cleareq"]["variable2"]) })
                        .addFields({ name: eval(client.la[ls]["cmds"]["filter"]["cleareq"]["variablex_3"]), value: eval(client.la[ls]["cmds"]["filter"]["cleareq"]["variable2"]) })
