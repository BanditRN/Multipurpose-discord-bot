            ...
            .reply({
                embeds: [
                    new EmbedBuilder()
                        ...
                        .setAuthor({ name: `${message.author.username} kills${message.mentions.users.first() ? " " + message.mentions.users.first().username : " him-/herself.."}`, iconURL: message.author.displayAvatarURL({ dynamic: true }) }),
                ],
            })
            .catch(() => {});
    },
