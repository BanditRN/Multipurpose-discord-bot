                                    ...
                                    return message.reply({
                                        embeds: [
                                            new EmbedBuilder()
                                                ...
                                                .setFooter(client.getFooter(es))
                                                .setTitle(
                                                    eval(client.la[ls]["cmds"]["administration"]["poll"]["variable5"])
                                                ),
                                        ],
                                    });
                                    ...
                                    .send({
                                        embeds: [
                                            new EmbedBuilder()
                                                ...
                                                .setDescription(
                                                    eval(client.la[ls]["cmds"]["administration"]["poll"]["variable7"])
                                                ),
                                        ],
                                    })
                                    .then(msg => {
                                                    ...
                                                    .reply({
                                                        embeds: [
                                                            new EmbedBuilder()
                                                                ...
                                                                .setTitle(
                                                                    eval(
                                                                        client.la[ls]["cmds"]["administration"]["poll"][
                                                                            "variable8"
                                                                        ]
                                                                    )
                                                                )
                                                    ...
                                                    message
                                                        ...
                                                        .then(msg => {
                                                            msg.channel
                                                                ...
                                                                .then(collected => {
                                                                    if (
                                                                        String(collected.first().content).toLowerCase() ==
                                                                        "finish"
                                                                    )
                                                                        send_poll();
                                                                    else {
                                                                        emojicounter++;
                                                                        emojicontent.push(
                                                                            String(collected.first().content).substring(
                                                                                0,
                                                                                1024
                                                                            )
                                                                        );
