                ...
                return message.reply({
                    embeds: [
                        new EmbedBuilder()
                            .setColor(es.wrongcolor)
                            .setFooter(client.getFooter(es))
                            .setTitle(`${allEmojis.msg.ERROR} **You forgot to ping a CHANNEL**`),
                    ],
                });
            if (!channel.isThread())
                return message.reply({
                    ...
                    message.reply({
                        embeds: [
                            new EmbedBuilder()
                                .setColor(es.color)
                                .setFooter(client.getFooter(es))
                                .setTitle(`${allEmojis.msg.SUCCESS} **I joined \`${channel.name}\`**`),
                        ],
                    });
                })
                .catch(() => {
                    message.reply({
                        embeds: [
                            new EmbedBuilder()
                                .setColor(es.wrongcolor)
                                .setFooter(client.getFooter(es))
                                .setTitle(`${allEmojis.msg.SUCCESS} **I couldn't join \`${channel.name}\`**`),
                        ],
                    });
                });
