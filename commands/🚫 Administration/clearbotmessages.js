        ...
        try {
            ...
            if (args[0]) {
                if (Number(args[0]) > 5000 || Number(args[0]) < 100)
                    return message.reply(eval(client.la[ls]["cmds"]["administration"]["clearbotmessages"]["variable4"]));
                if (isNaN(args[0]))
                    return message.reply({
                        content: eval(client.la[ls]["cmds"]["administration"]["clearbotmessages"]["variable5"]),
                    });
            ...
            while (channelMessages.size === 100) {
                ...
                if (channelMessages)
                    ...
                    messageCollection = messageCollection.concat(
                        channelMessages.filter(msg => msg.author.id == client.user.id)
                    ...
                    channel.send({
                        embeds: [
                            new EmbedBuilder()
                                ...
                                .setDescription(
                                    eval(client.la[ls]["cmds"]["administration"]["clearbotmessages"]["variable7"])
                                )
