...
const { databasing, arrayMove } = require(`${process.cwd()}/handlers/functions`);
module.exports = {
    name: `lockchannel`,
                    ...
                    message.reply({
                        embeds: [
                            new EmbedBuilder()
                                ...
                                .setFooter(client.getFooter(es))
                                .setTitle(
                                    `${allEmojis.msg.SUCCESS} **Successfully locked \`${channel.name}\` for ${users.length} Users and ${roles.length} Roles**`
                                ),
                        ],
                    });
                } else {
                    ...
                    message.reply({
                        embeds: [
                            new EmbedBuilder()
                                ...
                                .setFooter(client.getFooter(es))
                                .setTitle(
                                    `${allEmojis.msg.SUCCESS} **Successfully locked \`${channel.name}\` for ${users ? users.length : 0} Users and ${roles ? roles.length : 0} Roles**`
                                ),
                        ],
                    });
                } else {
