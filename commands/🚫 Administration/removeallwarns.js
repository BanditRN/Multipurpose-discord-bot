                    ...
                    .send({
                        embeds: [
                            new EmbedBuilder()
                                ...
                                .setFooter(client.getFooter(es))
                                .setAuthor({ name: `${message.author.tag} removed all ${warnIDs.length - toaddids.length} Warnings of **\`${message.guild.name}\`** from you!`, iconURL: message.author.displayAvatarURL({
                                        dynamic: true,
                                    }) }),
                        ],
                    })
                        ...
                        channel.send({
                            embeds: [
                                new EmbedBuilder()
                                    ...
                                    .setDescription(
                                        eval(client.la[ls]["cmds"]["administration"]["removeallwarns"]["variable8"])
                                    )
