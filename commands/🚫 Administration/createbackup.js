            ...
            .then(msg => {
                ...
                collector.on("collect", button => {
                    if (button?.user.id === cmduser.id) {
                        ...
                        button
                            ?.reply({
                                content: `<a:Loading:833101350623117342> **Now saving the Backup!**\nThis could take up to 2 Minutes (belongs to your data amount)`,
                            })
                            .catch(() => {});
                        // Create the backup
                        backup
                            ...
                            .then(backupData => {
                                ...
                                message.author
                                    ...
                                    .then(() => {
                                        message.channel.send(
                                            `${allEmojis.msg.SUCCESS} **Backup successfully created.** The backup ID was sent in dm!\n\n> *Have you tried: \`${prefix}setup-autobackup\`, to enable auto backups?*`
                                        );
                                    });
                            })
                            .catch(e => {
