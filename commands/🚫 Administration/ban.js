                    ...
                    .reply({
                        embeds: [
                            new EmbedBuilder()
                                ...
                                .setDescription(
                                    eval(client.la[ls]["cmds"]["administration"]["ban"]["variable5"]) +
                                ...
                                .reply({
                                    embeds: [
                                        new EmbedBuilder()
                                            ...
                                            .setDescription(
                                                eval(client.la[ls]["cmds"]["administration"]["ban"]["variable11"])
                                            ),
                                    ],
                                })
                                .catch(() => {});
                                ...
                                channel.send({
                                    embeds: [
                                        new EmbedBuilder()
                                            ...
                                            .setDescription(
                                                eval(client.la[ls]["cmds"]["administration"]["ban"]["variable14"])
                                            )
