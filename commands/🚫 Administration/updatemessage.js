                        ...
                        .reply({
                            embeds: [
                                new EmbedBuilder()
                                    ...
                                    .setDescription(
                                        eval(client.la[ls]["cmds"]["administration"]["updatemessage"]["variable9"])
                                    ),
                            ],
                        })
                        .then(msg => {
                    ...
                    return message.reply({
                        embeds: [
                            new EmbedBuilder()
                                ...
                                .setDescription(
                                    eval(client.la[ls]["cmds"]["administration"]["updatemessage"]["variable10"])
                                ),
                        ],
                    });
                });
