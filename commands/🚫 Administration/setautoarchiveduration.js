                ...
                return message.reply({
                    embeds: [
                        new EmbedBuilder()
                            .setColor(es.wrongcolor)
                            .setFooter(client.getFooter(es))
                            .setTitle(`${allEmojis.msg.ERROR} **You forgot to add a Cooldown amount**`)
            ...
            message.reply({
                embeds: [
                    new EmbedBuilder()
                        ...
                        .setFooter(client.getFooter(es))
                        .setTitle(
                            `${allEmojis.msg.SUCCESS} **Successfully changed the autoarchive Duration to \`${duration}\` of ${channel.name}**`
                        ),
                ],
            });
