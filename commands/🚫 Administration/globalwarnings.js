            ...
            if (!warnmember && args[0] && args[0].length == 18) {
                ...
                if (!tmp)
                    return message.reply({
                        content: eval(client.la[ls]["cmds"]["administration"]["globalwarnings"]["variable1"]),
                    });
                ...
                if (!warnmember || warnmember == null || !warnmember.id)
                    return message.reply({
                        content: eval(client.la[ls]["cmds"]["administration"]["globalwarnings"]["variable2"]),
                    });
                    ...
                    return message.reply({
                        embeds: [
                            new EmbedBuilder()
                                ...
                                .setFooter(
                                    client.getFooter(
                                        `He/She has: ${client.userProfiles.get(warnmember.id, "warnings") ? client.userProfiles.get(warnmember.id, "warnings").filter(v => v.guild == message.guild.id).length : 0} in ${message.guild.name}`,
