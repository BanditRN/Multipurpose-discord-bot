            ...
            message.reply({
                embeds: [
                    new EmbedBuilder()
                        .setColor(es.color)
                        .setAuthor({
                            name: `Loading '${args[0] ? args[0] : "Default"}' Music Mix`,
                            iconURL: "https://imgur.com/xutrSuq.gif",
                            url: link,
                        })
