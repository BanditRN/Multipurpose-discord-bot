            ...
            async function first_layer() {
                ...
                function menuselection(menu) {
                    ...
                    if (menu?.values[0] == "Cancel")
                        return menu?.reply(eval(client.la[ls]["cmds"]["owner"]["setup-advertise"]["variable5"]));
                    menu?.deferUpdate();
                    used1 = true;
                                                    ...
                                                    return message.channel.send({
                                                        embeds: [
                                                            new EmbedBuilder()
                                                                ...
                                                                .setTitle(
                                                                    eval(
                                                                        client.la[ls]["cmds"]["owner"]["setup-owner"][
                                                                            "variable10"
                                                                        ]
                                                                    )
                                                                )
                                            ...
                                            return message.reply({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setColor(es.wrongcolor)
                                                        .setDescription(
                                                            eval(client.la[ls]["cmds"]["owner"]["setup-owner"]["variable14"])
                                                        )
                                                        .setFooter(client.getFooter(es)),
                                                ],
                                            });
                                ...
                                return message.channel.send({
                                    embeds: [
                                        new EmbedBuilder()
                                            ...
                                            .setDescription(
                                                `Only <@${config.ownerIDS[0]}> and <@${config.ownerIDS[1]}> are allowed to do that!`
                                            ),
                                    ],
                                });
                            }
