...
module.exports = {
    ...
    run: async (client, message, args, cmduser, text, prefix) => {
        ...
        var ls = client.settings.get(message.guild.id, "language");
        try {
           ...
           */
            ...
            const collector = notemsg.createMessageComponentCollector({
            ...
            collector.on("collect", async b => {
                try {
                    if (b?.user.id !== message.author.id)
                        return b?.reply({
                            content: handlemsg(client.la[ls].cmds.info.help.buttonerror, { prefix: prefix }),
                            ephemeral: true,
                        });
                    //go home
                    if (b?.customId == "notes_create") {
                        if (notes.length >= 25)
                            return message
                                .reply("You've reached the Limit of Notes which is **25**")
                                .then(msg => {
                                    setTimeout(() => {
                                        try {
                                            msg.delete();
                        ...
                        var err = false;
                        await mmmm.channel
                            .awaitMessages({ filter: m => m.author.id == cmduser.id, max: 1, time: 180e3 })
                            .then(async collected => {
                                ...
                                if (title.length > 256) {
                                    ...
                                    message.reply(
                                        `*This is a Note: I've shortend your __Title__, cause \`256 Letters\` is the Maximum!*`
                                    );
                                }
                                var mmmmm = await message
                                    .reply("What should be the __Description__ of your **new Note** ?")
                                    .catch(e => {
                                        console.log(String(e).grey);
                                    });
                                ...
                                await mmmmm.channel
                                    ...
                                    .then(async collected => {
                                        ...
                                        if (description.length > 2048) {
                                            ...
                                            message
                                                .reply(
                                                    `*This is a Note: I've shortend your __Description__, cause \`2048 Letters\` is the Maximum!*`
                                                )
                                                .catch(e => {
                                                    console.log(String(e).grey);
                                                });
                                        ...
                                        var buttonRow2 = new ActionRowBuilder().addComponents([
                                            ...
                                            button_disable.setDisabled(false),
                                        ]);
                                        allbuttons = [buttonRow1, buttonRow2];
                                        await notemsg
                                            .edit({
                                        ...
                                        await delay(500);
                                        await message
                                            .reply(`**Successfully created your new Note and swapped to it!**`)
                                            .then(msg => {
                                                setTimeout(() => {
                                                    try {
                                                        msg.delete();
                    ...
                    if (b?.customId == "notes_jump") {
                        await b?.deferUpdate();
                        var mmmmm = await message
                            .reply(`**To which Page should I Jump?**\nPlease enter a Number between 1 and ${embeds.length}`)
                            .catch(e => {
                                console.log(String(e).grey);
                            });
                        var err = false;
                        await mmmmm.channel
                            ...
                            .then(async collected => {
                                ...
                                if (Page < 0 || Page > embeds.length - 1) {
                                    return message
                                        .reply("<:no:833101993668771842> **Value out of Range!**")
                                        .then(msg => {
                                            setTimeout(() => {
                                                try {
                                                    msg.delete();
                    ...
                    if (b?.customId == "notes_delete") {
                        ...
                        client.notes.remove(
                            message.author.id,
                            v =>
                                String(v.title).toLowerCase().trim().split(" ").join("") ==
                                String(embeds[currentPage].title).toLowerCase().trim().split(" ").join(""),
                            "notes"
                        );
                        if (currentPage !== 0) {
                            currentPage -= 1;
                    ...
                    if (b?.customId == "notes_edit") {
                        ...
                        try {
                            ...
                            let thenote = notes.findIndex(
                                v =>
                                    String(v.title).toLowerCase().trim().split(" ").join("") ==
                                    String(thmsg.embeds[0].title).toLowerCase().trim().split(" ").join("")
                            );
                                ...
                                .then(async collected => {
                                    ...
                                    await mmmmm.channel
                                        ...
                                        .then(async collected => {
                                            ...
                                            await delay(500);
                                            await message
                                                .reply(`**Successfully edited your Note!**`)
                                                .then(msg => {
                                                    setTimeout(() => {
                                                        try {
                                                            msg.delete();
