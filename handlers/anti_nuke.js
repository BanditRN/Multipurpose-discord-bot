            ...
            if (member.user.bot) {
                if (
                    ...
                    try {
                        ...
                        console.log(
                            "ANTI-NUKE SYSTEM - ERROR-CATCHER".dim.cyan,
                            e.stack ? String(e.stack).grey.grey : String(e).grey.grey
                        );
                        return;
                    }
                }
                                ...
                                ch.send({
                                    embeds: [
                                        new EmbedBuilder()
                                            ...
                                            .setDescription(
                                                eval(client.la[ls]["handlers"]["antinukejs"]["anti_nuke"]["variable6"])
                                            ),
                                    ],
                                }).catch(() => {});
                            }
                ...
                if (AddedMember) {
                    ...
                    if (
                        AddedMember.roles.cache.size > 0 &&
                        AddedMember.roles.cache.some(r => data.all.whitelisted.roles.includes(r.id))
                    ) {
                        if (data.all.showwhitelistlog && data.all.logger && data.all.logger.length > 5) {
                            try {
                                let ch = member.guild.channels.cache.get(data.all.logger);
                    ...
                    if (
                        AddedMember.roles.cache.size > 0 &&
                        AddedMember.roles.cache.some(r => data.antibot.whitelisted.roles.includes(r.id))
                    ) {
                        if (data.all.showwhitelistlog && data.all.logger && data.all.logger.length > 5) {
                            try {
                                let ch = member.guild.channels.cache.get(data.all.logger);
                    ...
                    try {
                        if (
                            data.antibot.punishment.member.removeroles.enabled && //for 1 Day check
                            ((data.antibot.punishment.member.removeroles.neededdaycount > 0 &&
                                memberData.antibot.filter(v => {
                                    return v - (Date.now() - 8640000000) > 0;
                                }).length > data.antibot.punishment.member.removeroles.neededdaycount) ||
                                //for 1 Week Check
                                (data.antibot.punishment.member.removeroles.neededweekcount > 0 &&
                                    memberData.antibot.filter(v => {
                                        return v - (Date.now() - 7 * 8640000000) > 0;
                                    }).length > data.antibot.punishment.member.removeroles.neededweekcount) ||
                                //for 1 Month Check
                                (data.antibot.punishment.member.removeroles.neededmonthcount > 0 &&
                                    memberData.antibot.filter(v => {
                                        return v - (Date.now() - 30 * 8640000000) > 0;
                                    }).length > data.antibot.punishment.member.removeroles.neededmonthcount) ||
                                //for All Time Check
                                (data.antibot.punishment.member.removeroles.noeededalltimecount > 0 &&
                                    memberData.antibot.length >
                                        data.antibot.punishment.member.removeroles.noeededalltimecount))
                        ) {
                            //KICK THE BOT
                            try {
                        ...
                        if (
                            AddedMember.kickable &&
                            data.antibot.punishment.member.kick.enabled && //for 1 Day check
                            ((data.antibot.punishment.member.kick.neededdaycount > 0 &&
                                memberData.antibot.filter(v => {
                                    return v - (Date.now() - 8640000000) > 0;
                                }).length > data.antibot.punishment.member.kick.neededdaycount) ||
                                //for 1 Week Check
                                (data.antibot.punishment.member.kick.neededweekcount > 0 &&
                                    memberData.antibot.filter(v => {
                                        return v - (Date.now() - 7 * 8640000000) > 0;
                                    }).length > data.antibot.punishment.member.kick.neededweekcount) ||
                                //for 1 Month Check
                                (data.antibot.punishment.member.kick.neededmonthcount > 0 &&
                                    memberData.antibot.filter(v => {
                                        return v - (Date.now() - 30 * 8640000000) > 0;
                                    }).length > data.antibot.punishment.member.kick.neededmonthcount) ||
                                //for All Time Check
                                (data.antibot.punishment.member.kick.noeededalltimecount > 0 &&
                                    memberData.antibot.length > data.antibot.punishment.member.kick.noeededalltimecount)) &&
                            (!data.antibot.punishment.member.ban.enabled || //for 1 Day check
                                (data.antibot.punishment.member.ban.neededdaycount > 0 &&
                                    memberData.antibot.filter(v => {
                                        return v - (Date.now() - 8640000000) > 0;
                                    }).length < data.antibot.punishment.member.ban.neededdaycount) ||
                                //for 1 Week Check
                                (data.antibot.punishment.member.ban.neededweekcount > 0 &&
                                    memberData.antibot.filter(v => {
                                        return v - (Date.now() - 7 * 8640000000) > 0;
                                    }).length < data.antibot.punishment.member.ban.neededweekcount) ||
                                //for 1 Month Check
                                (data.antibot.punishment.member.ban.neededmonthcount > 0 &&
                                    memberData.antibot.filter(v => {
                                        return v - (Date.now() - 30 * 8640000000) > 0;
                                    }).length < data.antibot.punishment.member.ban.neededmonthcount) ||
                                //for All Time Check
                                (data.antibot.punishment.member.ban.noeededalltimecount > 0 &&
                                    memberData.antibot.length < data.antibot.punishment.member.ban.noeededalltimecount)) //Only do the kick if no ban is enabled or if he doesnt have enough counts for getting banned
                        ) {
                            //KICK THE BOT
                            try {
                                if (!data.antibot.punishment.bot.ban && data.antibot.punishment.bot.kick) {
                        ...
                        if (
                            ...
                            ((data.antibot.punishment.member.ban.neededdaycount > 0 &&
                                ...
                                //for All Time Check
                                (data.antibot.punishment.member.ban.noeededalltimecount > 0 &&
                                    memberData.antibot.length > data.antibot.punishment.member.ban.noeededalltimecount))
                        ) {
                            //KICK THE BOT
                            try {
                                if (!data.antibot.punishment.bot.ban && data.antibot.punishment.bot.kick) {
    ...
    client.on("guildMemberRemove", async member => {
        try {
                                ...
                                ch.send({
                                    embeds: [
                                        new EmbedBuilder()
                                            ...
                                            .setDescription(
                                                eval(client.la[ls]["handlers"]["antinukejs"]["anti_nuke"]["variable24"])
                                            ),
                                    ],
                                }).catch(() => {});
                            }
            ...
            if (AddedMember) {
                ...
                if (
                    AddedMember.roles.cache.size > 0 &&
                    AddedMember.roles.cache.some(r => data.antideleteuser.whitelisted.roles.includes(r.id))
                ) {
                    if (data.all.showwhitelistlog && data.all.logger && data.all.logger.length > 5) {
                        try {
                            let ch = member.guild.channels.cache.get(data.all.logger);
                ...
                try {
                    if (
                        data.antideleteuser.punishment.member.removeroles.enabled && //for 1 Day check
                        ((data.antideleteuser.punishment.member.removeroles.neededdaycount > 0 &&
                            memberData.antideleteuser.filter(v => {
                                return v - (Date.now() - 8640000000) > 0;
                            }).length > data.antideleteuser.punishment.member.removeroles.neededdaycount) ||
                            //for 1 Week Check
                            (data.antideleteuser.punishment.member.removeroles.neededweekcount > 0 &&
                                memberData.antideleteuser.filter(v => {
                                    return v - (Date.now() - 7 * 8640000000) > 0;
                                }).length > data.antideleteuser.punishment.member.removeroles.neededweekcount) ||
                            //for 1 Month Check
                            (data.antideleteuser.punishment.member.removeroles.neededmonthcount > 0 &&
                                memberData.antideleteuser.filter(v => {
                                    return v - (Date.now() - 30 * 8640000000) > 0;
                                }).length > data.antideleteuser.punishment.member.removeroles.neededmonthcount) ||
                            //for All Time Check
                            (data.antideleteuser.punishment.member.removeroles.noeededalltimecount > 0 &&
                                memberData.antideleteuser.length >
                                    data.antideleteuser.punishment.member.removeroles.noeededalltimecount))
                    ) {
                        //Remove his/her roles
                        let roles2set = [];
                        if (data.all.quarantine && data.all.quarantine.length > 5) {
                    ...
                    if (
                        AddedMember.kickable &&
                        data.antideleteuser.punishment.member.kick.enabled && //for 1 Day check
                        ((data.antideleteuser.punishment.member.kick.neededdaycount > 0 &&
                            memberData.antideleteuser.filter(v => {
                                return v - (Date.now() - 8640000000) > 0;
                            }).length > data.antideleteuser.punishment.member.kick.neededdaycount) ||
                            //for 1 Week Check
                            (data.antideleteuser.punishment.member.kick.neededweekcount > 0 &&
                                memberData.antideleteuser.filter(v => {
                                    return v - (Date.now() - 7 * 8640000000) > 0;
                                }).length > data.antideleteuser.punishment.member.kick.neededweekcount) ||
                            //for 1 Month Check
                            (data.antideleteuser.punishment.member.kick.neededmonthcount > 0 &&
                                memberData.antideleteuser.filter(v => {
                                    return v - (Date.now() - 30 * 8640000000) > 0;
                                }).length > data.antideleteuser.punishment.member.kick.neededmonthcount) ||
                            //for All Time Check
                            (data.antideleteuser.punishment.member.kick.noeededalltimecount > 0 &&
                                memberData.antideleteuser.length >
                                    data.antideleteuser.punishment.member.kick.noeededalltimecount)) &&
                        (!data.antideleteuser.punishment.member.ban.enabled || //for 1 Day check
                            (data.antideleteuser.punishment.member.ban.neededdaycount > 0 &&
                                memberData.antideleteuser.filter(v => {
                                    return v - (Date.now() - 8640000000) > 0;
                                }).length < data.antideleteuser.punishment.member.ban.neededdaycount) ||
                            //for 1 Week Check
                            (data.antideleteuser.punishment.member.ban.neededweekcount > 0 &&
                                memberData.antideleteuser.filter(v => {
                                    return v - (Date.now() - 7 * 8640000000) > 0;
                                }).length < data.antideleteuser.punishment.member.ban.neededweekcount) ||
                            //for 1 Month Check
                            (data.antideleteuser.punishment.member.ban.neededmonthcount > 0 &&
                                memberData.antideleteuser.filter(v => {
                                    return v - (Date.now() - 30 * 8640000000) > 0;
                                }).length < data.antideleteuser.punishment.member.ban.neededmonthcount) ||
                            //for All Time Check
                            (data.antideleteuser.punishment.member.ban.noeededalltimecount > 0 &&
                                memberData.antideleteuser.length <
                    ...
                    if (
                        ...
                        ((data.antideleteuser.punishment.member.ban.neededdaycount > 0 &&
                            ...
                            (data.antideleteuser.punishment.member.ban.noeededalltimecount > 0 &&
                                memberData.antideleteuser.length >
                                    data.antideleteuser.punishment.member.ban.noeededalltimecount))
                    ) {
                        //Ban the Member
                        AddedMember.ban({
                                ...
                                ch.send({
                                    embeds: [
                                        new EmbedBuilder()
                                            ...
                                            .setDescription(
                                                eval(client.la[ls]["handlers"]["antinukejs"]["anti_nuke"]["variable39"])
                                            ),
                                    ],
                                }).catch(() => {});
                            }
    ...
    client.on("channelCreate", async channel => {
        try {
                                ...
                                ch.send({
                                    embeds: [
                                        new EmbedBuilder()
                                            ...
                                            .setDescription(
                                                eval(client.la[ls]["handlers"]["antinukejs"]["anti_nuke"]["variable54"])
                                            ),
                                    ],
                                }).catch(() => {});
                            }
            ...
            if (AddedMember) {
                ...
                if (
                    AddedMember.roles.cache.size > 0 &&
                    AddedMember.roles.cache.some(r => data.antichannelcreate.whitelisted.roles.includes(r.id))
                ) {
                    if (data.all.showwhitelistlog && data.all.logger && data.all.logger.length > 5) {
                        try {
                            let ch = channel.guild.channels.cache.get(data.all.logger);
                ...
                try {
                    if (
                        data.antichannelcreate.punishment.member.removeroles.enabled && //for 1 Day check
                        ((data.antichannelcreate.punishment.member.removeroles.neededdaycount > 0 &&
                            memberData.antichannelcreate.filter(v => {
                                return v - (Date.now() - 8640000000) > 0;
                            }).length > data.antichannelcreate.punishment.member.removeroles.neededdaycount) ||
                            //for 1 Week Check
                            (data.antichannelcreate.punishment.member.removeroles.neededweekcount > 0 &&
                                memberData.antichannelcreate.filter(v => {
                                    return v - (Date.now() - 7 * 8640000000) > 0;
                                }).length > data.antichannelcreate.punishment.member.removeroles.neededweekcount) ||
                            //for 1 Month Check
                            (data.antichannelcreate.punishment.member.removeroles.neededmonthcount > 0 &&
                                memberData.antichannelcreate.filter(v => {
                                    return v - (Date.now() - 30 * 8640000000) > 0;
                                }).length > data.antichannelcreate.punishment.member.removeroles.neededmonthcount) ||
                            //for All Time Check
                            (data.antichannelcreate.punishment.member.removeroles.noeededalltimecount > 0 &&
                                memberData.antichannelcreate.length >
                                    data.antichannelcreate.punishment.member.removeroles.noeededalltimecount))
                    ) {
                        try {
                    ...
                    if (
                        AddedMember.kickable &&
                        data.antichannelcreate.punishment.member.kick.enabled && //for 1 Day check
                        ((data.antichannelcreate.punishment.member.kick.neededdaycount > 0 &&
                            memberData.antichannelcreate.filter(v => {
                                return v - (Date.now() - 8640000000) > 0;
                            }).length > data.antichannelcreate.punishment.member.kick.neededdaycount) ||
                            //for 1 Week Check
                            (data.antichannelcreate.punishment.member.kick.neededweekcount > 0 &&
                                memberData.antichannelcreate.filter(v => {
                                    return v - (Date.now() - 7 * 8640000000) > 0;
                                }).length > data.antichannelcreate.punishment.member.kick.neededweekcount) ||
                            //for 1 Month Check
                            (data.antichannelcreate.punishment.member.kick.neededmonthcount > 0 &&
                                memberData.antichannelcreate.filter(v => {
                                    return v - (Date.now() - 30 * 8640000000) > 0;
                                }).length > data.antichannelcreate.punishment.member.kick.neededmonthcount) ||
                            //for All Time Check
                            (data.antichannelcreate.punishment.member.kick.noeededalltimecount > 0 &&
                                memberData.antichannelcreate.length >
                                    data.antichannelcreate.punishment.member.kick.noeededalltimecount)) &&
                        (!data.antichannelcreate.punishment.member.ban.enabled || //for 1 Day check
                            (data.antichannelcreate.punishment.member.ban.neededdaycount > 0 &&
                                memberData.antichannelcreate.filter(v => {
                                    return v - (Date.now() - 8640000000) > 0;
                                }).length < data.antichannelcreate.punishment.member.ban.neededdaycount) ||
                            //for 1 Week Check
                            (data.antichannelcreate.punishment.member.ban.neededweekcount > 0 &&
                                memberData.antichannelcreate.filter(v => {
                                    return v - (Date.now() - 7 * 8640000000) > 0;
                                }).length < data.antichannelcreate.punishment.member.ban.neededweekcount) ||
                            //for 1 Month Check
                            (data.antichannelcreate.punishment.member.ban.neededmonthcount > 0 &&
                                memberData.antichannelcreate.filter(v => {
                                    return v - (Date.now() - 30 * 8640000000) > 0;
                                }).length < data.antichannelcreate.punishment.member.ban.neededmonthcount) ||
                            //for All Time Check
                            (data.antichannelcreate.punishment.member.ban.noeededalltimecount > 0 &&
                                memberData.antichannelcreate.length <
                                    data.antichannelcreate.punishment.member.ban.noeededalltimecount)) //Only do the kick if no ban is enabled or if he doesnt have enough counts for getting banned
                    ) {
                        try {
                            if (data.antichannelcreate.punishment.deletecreatedchannel) {
                                //if there is a logger enabled then log the data
                        ...
                        //Kick the Member
                        AddedMember.kick(`ANTI CHANNEL CREATE - He created: ${channel.id} | ${channel.name}`)
                            .then(member => {
                                //If there is the logger enabled, send information
                                if (data.all.logger && data.all.logger.length > 5) {
                                    try {
                    ...
                    if (
                        ...
                        ((data.antichannelcreate.punishment.member.ban.neededdaycount > 0 &&
                            ...
                            (data.antichannelcreate.punishment.member.ban.noeededalltimecount > 0 &&
                                memberData.antichannelcreate.length >
                                    data.antichannelcreate.punishment.member.ban.noeededalltimecount))
                    ) {
                        try {
                            if (data.antichannelcreate.punishment.deletecreatedchannel) {
                                //if there is a logger enabled then log the data
    ...
    client.on("channelDelete", async channel => {
        try {
                                ...
                                ch.send({
                                    embeds: [
                                        new EmbedBuilder()
                                            ...
                                            .setDescription(
                                                eval(client.la[ls]["handlers"]["antinukejs"]["anti_nuke"]["variable72"])
                                            ),
                                    ],
                                }).catch(() => {});
                            }
            ...
            if (AddedMember) {
                ...
                if (
                    AddedMember.roles.cache.size > 0 &&
                    AddedMember.roles.cache.some(r => data.antichanneldelete.whitelisted.roles.includes(r.id))
                ) {
                    if (data.all.showwhitelistlog && data.all.logger && data.all.logger.length > 5) {
                        try {
                            let ch = channel.guild.channels.cache.get(data.all.logger);
                ...
                try {
                    if (
                        data.antichanneldelete.punishment.member.removeroles.enabled && //for 1 Day check
                        ((data.antichanneldelete.punishment.member.removeroles.neededdaycount > 0 &&
                            memberData.antichanneldelete.filter(v => {
                                return v - (Date.now() - 8640000000) > 0;
                            }).length > data.antichanneldelete.punishment.member.removeroles.neededdaycount) ||
                            //for 1 Week Check
                            (data.antichanneldelete.punishment.member.removeroles.neededweekcount > 0 &&
                                memberData.antichanneldelete.filter(v => {
                                    return v - (Date.now() - 7 * 8640000000) > 0;
                                }).length > data.antichanneldelete.punishment.member.removeroles.neededweekcount) ||
                            //for 1 Month Check
                            (data.antichanneldelete.punishment.member.removeroles.neededmonthcount > 0 &&
                                memberData.antichanneldelete.filter(v => {
                                    return v - (Date.now() - 30 * 8640000000) > 0;
                                }).length > data.antichanneldelete.punishment.member.removeroles.neededmonthcount) ||
                            //for All Time Check
                            (data.antichanneldelete.punishment.member.removeroles.noeededalltimecount > 0 &&
                                memberData.antichanneldelete.length >
                                    data.antichanneldelete.punishment.member.removeroles.noeededalltimecount))
                    ) {
                        //Remove his/her roles
                        let roles2set = [];
                        if (data.all.quarantine && data.all.quarantine.length > 5) {
                    ...
                    if (
                        AddedMember.kickable &&
                        data.antichanneldelete.punishment.member.kick.enabled && //for 1 Day check
                        ((data.antichanneldelete.punishment.member.kick.neededdaycount > 0 &&
                            memberData.antichanneldelete.filter(v => {
                                return v - (Date.now() - 8640000000) > 0;
                            }).length > data.antichanneldelete.punishment.member.kick.neededdaycount) ||
                            //for 1 Week Check
                            (data.antichanneldelete.punishment.member.kick.neededweekcount > 0 &&
                                memberData.antichanneldelete.filter(v => {
                                    return v - (Date.now() - 7 * 8640000000) > 0;
                                }).length > data.antichanneldelete.punishment.member.kick.neededweekcount) ||
                            //for 1 Month Check
                            (data.antichanneldelete.punishment.member.kick.neededmonthcount > 0 &&
                                memberData.antichanneldelete.filter(v => {
                                    return v - (Date.now() - 30 * 8640000000) > 0;
                                }).length > data.antichanneldelete.punishment.member.kick.neededmonthcount) ||
                            //for All Time Check
                            (data.antichanneldelete.punishment.member.kick.noeededalltimecount > 0 &&
                                memberData.antichanneldelete.length >
                                    data.antichanneldelete.punishment.member.kick.noeededalltimecount)) &&
                        (!data.antichanneldelete.punishment.member.ban.enabled || //for 1 Day check
                            (data.antichanneldelete.punishment.member.ban.neededdaycount > 0 &&
                                memberData.antichanneldelete.filter(v => {
                                    return v - (Date.now() - 8640000000) > 0;
                                }).length < data.antichanneldelete.punishment.member.ban.neededdaycount) ||
                            //for 1 Week Check
                            (data.antichanneldelete.punishment.member.ban.neededweekcount > 0 &&
                                memberData.antichanneldelete.filter(v => {
                                    return v - (Date.now() - 7 * 8640000000) > 0;
                                }).length < data.antichanneldelete.punishment.member.ban.neededweekcount) ||
                            //for 1 Month Check
                            (data.antichanneldelete.punishment.member.ban.neededmonthcount > 0 &&
                                memberData.antichanneldelete.filter(v => {
                                    return v - (Date.now() - 30 * 8640000000) > 0;
                                }).length < data.antichanneldelete.punishment.member.ban.neededmonthcount) ||
                            //for All Time Check
                            (data.antichanneldelete.punishment.member.ban.noeededalltimecount > 0 &&
                                memberData.antichanneldelete.length <
                                    data.antichanneldelete.punishment.member.ban.noeededalltimecount)) //Only do the kick if no ban is enabled or if he doesnt have enough counts for getting banned
                    ) {
                        //Kick the Member
                        AddedMember.kick(`Anti CHANNEL DELETE - He created: ${channel.id} | ${channel.name}`)
                            .then(member => {
                                //If there is the logger enabled, send information
                                if (data.all.logger && data.all.logger.length > 5) {
                                    try {
                    ...
                    if (
                        ...
                        ((data.antichanneldelete.punishment.member.ban.neededdaycount > 0 &&
                            ...
                            (data.antichanneldelete.punishment.member.ban.noeededalltimecount > 0 &&
                                memberData.antichanneldelete.length >
                                    data.antichanneldelete.punishment.member.ban.noeededalltimecount))
                    ) {
                        //Ban the Member
                        AddedMember.ban({
    ...
    client.on("roleCreate", async role => {
        try {
                                ...
                                ch.send({
                                    embeds: [
                                        new EmbedBuilder()
                                            ...
                                            .setDescription(
                                                eval(client.la[ls]["handlers"]["antinukejs"]["anti_nuke"]["variable87"])
                                            ),
                                    ],
                                }).catch(() => {});
                            }
            ...
            if (AddedMember) {
                ...
                if (
                    AddedMember.roles.cache.size > 0 &&
                    AddedMember.roles.cache.some(r => data.anticreaterole.whitelisted.roles.includes(r.id))
                ) {
                    if (data.all.showwhitelistlog && data.all.logger && data.all.logger.length > 5) {
                        try {
                            let ch = role.guild.channels.cache.get(data.all.logger);
                ...
                try {
                    if (
                        data.anticreaterole.punishment.member.removeroles.enabled && //for 1 Day check
                        ((data.anticreaterole.punishment.member.removeroles.neededdaycount > 0 &&
                            memberData.anticreaterole.filter(v => {
                                return v - (Date.now() - 8640000000) > 0;
                            }).length > data.anticreaterole.punishment.member.removeroles.neededdaycount) ||
                            //for 1 Week Check
                            (data.anticreaterole.punishment.member.removeroles.neededweekcount > 0 &&
                                memberData.anticreaterole.filter(v => {
                                    return v - (Date.now() - 7 * 8640000000) > 0;
                                }).length > data.anticreaterole.punishment.member.removeroles.neededweekcount) ||
                            //for 1 Month Check
                            (data.anticreaterole.punishment.member.removeroles.neededmonthcount > 0 &&
                                memberData.anticreaterole.filter(v => {
                                    return v - (Date.now() - 30 * 8640000000) > 0;
                                }).length > data.anticreaterole.punishment.member.removeroles.neededmonthcount) ||
                            //for All Time Check
                            (data.anticreaterole.punishment.member.removeroles.noeededalltimecount > 0 &&
                                memberData.anticreaterole.length >
                                    data.anticreaterole.punishment.member.removeroles.noeededalltimecount))
                    ) {
                        try {
                    ...
                    if (
                        AddedMember.kickable &&
                        data.anticreaterole.punishment.member.kick.enabled && //for 1 Day check
                        ((data.anticreaterole.punishment.member.kick.neededdaycount > 0 &&
                            memberData.anticreaterole.filter(v => {
                                return v - (Date.now() - 8640000000) > 0;
                            }).length > data.anticreaterole.punishment.member.kick.neededdaycount) ||
                            //for 1 Week Check
                            (data.anticreaterole.punishment.member.kick.neededweekcount > 0 &&
                                memberData.anticreaterole.filter(v => {
                                    return v - (Date.now() - 7 * 8640000000) > 0;
                                }).length > data.anticreaterole.punishment.member.kick.neededweekcount) ||
                            //for 1 Month Check
                            (data.anticreaterole.punishment.member.kick.neededmonthcount > 0 &&
                                memberData.anticreaterole.filter(v => {
                                    return v - (Date.now() - 30 * 8640000000) > 0;
                                }).length > data.anticreaterole.punishment.member.kick.neededmonthcount) ||
                            //for All Time Check
                            (data.anticreaterole.punishment.member.kick.noeededalltimecount > 0 &&
                                memberData.anticreaterole.length >
                                    data.anticreaterole.punishment.member.kick.noeededalltimecount)) &&
                        (!data.anticreaterole.punishment.member.ban.enabled || //for 1 Day check
                            (data.anticreaterole.punishment.member.ban.neededdaycount > 0 &&
                                memberData.anticreaterole.filter(v => {
                                    return v - (Date.now() - 8640000000) > 0;
                                }).length < data.anticreaterole.punishment.member.ban.neededdaycount) ||
                            //for 1 Week Check
                            (data.anticreaterole.punishment.member.ban.neededweekcount > 0 &&
                                memberData.anticreaterole.filter(v => {
                                    return v - (Date.now() - 7 * 8640000000) > 0;
                                }).length < data.anticreaterole.punishment.member.ban.neededweekcount) ||
                            //for 1 Month Check
                            (data.anticreaterole.punishment.member.ban.neededmonthcount > 0 &&
                                memberData.anticreaterole.filter(v => {
                                    return v - (Date.now() - 30 * 8640000000) > 0;
                                }).length < data.anticreaterole.punishment.member.ban.neededmonthcount) ||
                            //for All Time Check
                            (data.anticreaterole.punishment.member.ban.noeededalltimecount > 0 &&
                                memberData.anticreaterole.length <
                                    data.anticreaterole.punishment.member.ban.noeededalltimecount)) //Only do the kick if no ban is enabled or if he doesnt have enough counts for getting banned
                    ) {
                        try {
                            if (data.anticreaterole.punishment.removeaddedrole) {
                                //if there is a logger enabled then log the data
                        ...
                        //Kick the Member
                        AddedMember.kick(`ANTI ROLE CREATE - He/She created: ${role.id} | ${role.name}`)
                            .then(member => {
                                //If there is the logger enabled, send information
                                if (data.all.logger && data.all.logger.length > 5) {
                                    try {
                    ...
                    if (
                        ...
                        ((data.anticreaterole.punishment.member.ban.neededdaycount > 0 &&
                            ...
                            (data.anticreaterole.punishment.member.ban.noeededalltimecount > 0 &&
                                memberData.anticreaterole.length >
                                    data.anticreaterole.punishment.member.ban.noeededalltimecount))
                    ) {
                        try {
                            if (data.anticreaterole.punishment.removeaddedrole) {
                                //if there is a logger enabled then log the data
    ...
    client.on("roleDelete", async role => {
        try {
                                ...
                                ch.send({
                                    embeds: [
                                        new EmbedBuilder()
                                            ...
                                            .setDescription(
                                                eval(client.la[ls]["handlers"]["antinukejs"]["anti_nuke"]["variable105"])
                                            ),
                                    ],
                                }).catch(() => {});
                            }
            ...
            if (AddedMember) {
                ...
                if (
                    AddedMember.roles.cache.size > 0 &&
                    AddedMember.roles.cache.some(r => data.antideleterole.whitelisted.roles.includes(r.id))
                ) {
                    if (data.all.showwhitelistlog && data.all.logger && data.all.logger.length > 5) {
                        try {
                            let ch = role.guild.channels.cache.get(data.all.logger);
                ...
                try {
                    if (
                        data.antideleterole.punishment.member.removeroles.enabled && //for 1 Day check
                        ((data.antideleterole.punishment.member.removeroles.neededdaycount > 0 &&
                            memberData.antideleterole.filter(v => {
                                return v - (Date.now() - 8640000000) > 0;
                            }).length > data.antideleterole.punishment.member.removeroles.neededdaycount) ||
                            //for 1 Week Check
                            (data.antideleterole.punishment.member.removeroles.neededweekcount > 0 &&
                                memberData.antideleterole.filter(v => {
                                    return v - (Date.now() - 7 * 8640000000) > 0;
                                }).length > data.antideleterole.punishment.member.removeroles.neededweekcount) ||
                            //for 1 Month Check
                            (data.antideleterole.punishment.member.removeroles.neededmonthcount > 0 &&
                                memberData.antideleterole.filter(v => {
                                    return v - (Date.now() - 30 * 8640000000) > 0;
                                }).length > data.antideleterole.punishment.member.removeroles.neededmonthcount) ||
                            //for All Time Check
                            (data.antideleterole.punishment.member.removeroles.noeededalltimecount > 0 &&
                                memberData.antideleterole.length >
                                    data.antideleterole.punishment.member.removeroles.noeededalltimecount))
                    ) {
                        //Remove his/her roles
                        let roles2set = [];
                        if (data.all.quarantine && data.all.quarantine.length > 5) {
                    ...
                    if (
                        AddedMember.kickable &&
                        data.antideleterole.punishment.member.kick.enabled && //for 1 Day check
                        ((data.antideleterole.punishment.member.kick.neededdaycount > 0 &&
                            memberData.antideleterole.filter(v => {
                                return v - (Date.now() - 8640000000) > 0;
                            }).length > data.antideleterole.punishment.member.kick.neededdaycount) ||
                            //for 1 Week Check
                            (data.antideleterole.punishment.member.kick.neededweekcount > 0 &&
                                memberData.antideleterole.filter(v => {
                                    return v - (Date.now() - 7 * 8640000000) > 0;
                                }).length > data.antideleterole.punishment.member.kick.neededweekcount) ||
                            //for 1 Month Check
                            (data.antideleterole.punishment.member.kick.neededmonthcount > 0 &&
                                memberData.antideleterole.filter(v => {
                                    return v - (Date.now() - 30 * 8640000000) > 0;
                                }).length > data.antideleterole.punishment.member.kick.neededmonthcount) ||
                            //for All Time Check
                            (data.antideleterole.punishment.member.kick.noeededalltimecount > 0 &&
                                memberData.antideleterole.length >
                                    data.antideleterole.punishment.member.kick.noeededalltimecount)) &&
                        (!data.antideleterole.punishment.member.ban.enabled || //for 1 Day check
                            (data.antideleterole.punishment.member.ban.neededdaycount > 0 &&
                                memberData.antideleterole.filter(v => {
                                    return v - (Date.now() - 8640000000) > 0;
                                }).length < data.antideleterole.punishment.member.ban.neededdaycount) ||
                            //for 1 Week Check
                            (data.antideleterole.punishment.member.ban.neededweekcount > 0 &&
                                memberData.antideleterole.filter(v => {
                                    return v - (Date.now() - 7 * 8640000000) > 0;
                                }).length < data.antideleterole.punishment.member.ban.neededweekcount) ||
                            //for 1 Month Check
                            (data.antideleterole.punishment.member.ban.neededmonthcount > 0 &&
                                memberData.antideleterole.filter(v => {
                                    return v - (Date.now() - 30 * 8640000000) > 0;
                                }).length < data.antideleterole.punishment.member.ban.neededmonthcount) ||
                            //for All Time Check
                            (data.antideleterole.punishment.member.ban.noeededalltimecount > 0 &&
                                memberData.antideleterole.length <
                                    data.antideleterole.punishment.member.ban.noeededalltimecount)) //Only do the kick if no ban is enabled or if he doesnt have enough counts for getting banned
                    ) {
                        //Kick the Member
                        AddedMember.kick(`ANTI ROLE DELETE - He/She created: ${role.id} | ${role.name}`)
                            .then(member => {
                                //If there is the logger enabled, send information
                                if (data.all.logger && data.all.logger.length > 5) {
                                    try {
                    ...
                    if (
                        ...
                        ((data.antideleterole.punishment.member.ban.neededdaycount > 0 &&
                            ...
                            (data.antideleterole.punishment.member.ban.noeededalltimecount > 0 &&
                                memberData.antideleterole.length >
                                    data.antideleterole.punishment.member.ban.noeededalltimecount))
                    ) {
                        //Ban the Member
                        AddedMember.ban({
