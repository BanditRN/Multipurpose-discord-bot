...
module.exports = client => {
    const { databasing, check_voice_channels, create_join_to_create_Channel, isValidURL, delay } = require(`./functions`);
        ...
        try {
            ...
            client.settings.ensure(message.guild.id, {
                antidiscord: {
                    ...
                    whitelistedchannels: [],
                    mute_amount: 2,
                    whitelistedlinks: ["discord.gg/milrato", "discord.gg/djs"],
                },
            });
            client.settings.ensure(message.guild.id, {
                autowarn: {
                                    ...
                                    message.channel.send({
                                        embeds: [
                                            new EmbedBuilder()
                                                ...
                                                .setDescription(
                                                    `> <@${message.author.id}> **received an autogenerated Warn - \`antidiscord\`**!\n\n> **He now has \`${warnings.length} Warnings\`**`
                                                ),
                                        ],
                                    });
                                            ...
                                            message.channel.send({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setTitle(
                                                            eval(
                                                                client.la[ls]["cmds"]["administration"]["warn"]["variable8"]
                                                            )
                                                        ),
                                                ],
                                            });
                                            ...
                                            message.channel.send({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setTitle(
                                                            eval(
                                                                client.la[ls]["cmds"]["administration"]["warn"]["variable16"]
                                                            )
                                                        ),
                                                ],
                                            });
                                                ...
                                                .send({
                                                    embeds: [
                                                        new EmbedBuilder()
                                                            ...
                                                            .setTitle(
                                                                eval(
                                                                    client.la[ls]["handlers"]["antidiscordjs"][
                                                                        "antidiscord"
                                                                    ]["variable1"]
                                                                )
                                                            )
                                        ...
                                        .send({
                                            embeds: [
                                                new EmbedBuilder()
                                                    ...
                                                    .setTitle(
                                                        eval(
                                                            client.la[ls]["handlers"]["antidiscordjs"]["antidiscord"][
                                                                "variable5"
                                                            ]
                                                        )
                                                    ),
                    ...
                    .send({
                        embeds: [
                            new EmbedBuilder()
                                ...
                                .setTitle(client.la[ls].common.erroroccur)
                                .setDescription(
                                    eval(client.la[ls]["handlers"]["antidiscordjs"]["antidiscord"]["variable6"])
                                ),
                        ],
                    })
                    .catch(() => {});
