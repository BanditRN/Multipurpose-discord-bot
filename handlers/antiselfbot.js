        ...
        try {
            ...
            if (
                ...
                message.embeds.some(
                    e =>
                        e.type != "rich" ||
                        (e.footer && e.footer.text === "Twitter") ||
                        (e.author && e.author.url && e.author.url.includes("twitter.com"))
                )
            )
                return; //means no self bot
            ...
            try {
                if (autowarn.antiselfbot) {
                    ...
                    message.channel.send({
                        embeds: [
                            new EmbedBuilder()
                                .setAuthor({ name: client.getAuthor(message.author.tag, message.member.displayAvatarURL({ dynamic: true })) })
                                .setColor("ORANGE")
                                .setFooter(
                                    client.getFooter(
                                        "ID: " + message.author.id,
                                ...
                                .setDescription(
                                    `> <@${message.author.id}> **received an autogenerated Warn - \`antiselfbot\`**!\n\n> **He now has \`${warnings.length} Warnings\`**`
                                ),
                        ],
                    });
                                        ...
                                        message.channel.send({
                                            embeds: [
                                                new EmbedBuilder()
                                                    ...
                                                    .setFooter(client.getFooter(es))
                                                    .setTitle(
                                                        eval(client.la[ls]["cmds"]["administration"]["warn"]["variable13"])
                                                    )
                                                    .setDescription(
                                        ...
                                        message.channel.send({
                                            embeds: [
                                                new EmbedBuilder()
                                                    ...
                                                    .setFooter(client.getFooter(es))
                                                    .setTitle(
                                                        eval(client.la[ls]["cmds"]["administration"]["warn"]["variable20"])
                                                    )
                                                    .setDescription(
