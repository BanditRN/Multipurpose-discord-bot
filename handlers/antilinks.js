    ...
    async function checkAntiLinks(message) {
        try {
            ...
            try {
                ...
                if (
                    client.setups.get("TICKETS", "tickets")?.includes(message.channel.id) ||
                        ...
                        if (isValidURL(arg) && isAllowedUrl(arg, antisettings)) {
                            ...
                            if (message.content.includes("```")) {
                                try {
                                    ...
                                    message.author
                                        .send(
                                            `It seems like you sent a code in ${message.channel} **${message.guild.name}**, but it contains a Link, which isn't allowed!`
                                        )
                                        .catch(e => {
                                            console.log(String(e));
                                        });
                                ...
                                message.channel.send({
                                    embeds: [
                                        new EmbedBuilder()
                                            ...
                                            .setDescription(
                                                `> <@${message.author.id}> **received an autogenerated Warn - \`antilinks\`**!\n\n> **He now has \`${warnings.length} Warnings\`**`
                                            ),
                                    ],
                                });
                                        ...
                                        message.channel.send({
                                            embeds: [
                                                new EmbedBuilder()
                                                    ...
                                                    .setTitle(
                                                        eval(client.la[ls]["cmds"]["administration"]["warn"]["variable8"])
                                                    ),
                                            ],
                                        });
                                    else {
                                            ...
                                            message.member.send({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setTitle(
                                                            eval(
                                                                client.la[ls]["cmds"]["administration"]["warn"]["variable9"]
                                                            )
                                                        )
                                                        .setDescription(
                                                            eval(
                                                                client.la[ls]["cmds"]["administration"]["warn"]["variable10"]
                                                            )
                                                        ),
                                                ],
                                            });
                                            ...
                                            return message.channel.send({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setTitle(
                                                            eval(
                                                                client.la[ls]["cmds"]["administration"]["warn"]["variable11"]
                                                            )
                                                        )
                                                        .setDescription(
                                                            eval(
                                                                client.la[ls]["cmds"]["administration"]["warn"]["variable12"]
                                                            )
                                                        ),
                                                ],
                                            });
                                                    ...
                                                    message.channel.send({
                                                        embeds: [
                                                            new EmbedBuilder()
                                                                ...
                                                                .setTitle(
                                                                    eval(
                                                                        client.la[ls]["cmds"]["administration"]["warn"][
                                                                            "variable13"
                                                                        ]
                                                                    )
                                                                )
                                            ...
                                            message.channel.send({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setDescription(
                                                            eval(
                                                                client.la[ls]["cmds"]["administration"]["warn"]["variable15"]
                                                            )
                                                        ),
                                                ],
                                            });
                                        ...
                                        message.channel.send({
                                            embeds: [
                                                new EmbedBuilder()
                                                    ...
                                                    .setFooter(client.getFooter(es))
                                                    .setTitle(
                                                        eval(client.la[ls]["cmds"]["administration"]["warn"]["variable16"])
                                                    ),
                                            ],
                                        });
                                    else {
                                            ...
                                            message.member.send({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setTitle(
                                                            eval(
                                                                client.la[ls]["cmds"]["administration"]["warn"]["variable17"]
                                                            )
                                                        ),
                                                ],
                                            });
                                            ...
                                            message.channel.send({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setTitle(
                                                            eval(
                                                                client.la[ls]["cmds"]["administration"]["warn"]["variable18"]
                                                            )
                                                        )
                                                        .setDescription(
                                                            eval(
                                                                client.la[ls]["cmds"]["administration"]["warn"]["variable19"]
                                                            )
                                                        ),
                                                ],
                                            });
                                            ...
                                            message.channel.send({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setTitle(
                                                            eval(
                                                                client.la[ls]["cmds"]["administration"]["warn"]["variable22"]
                                                            )
                                                        )
                                                        .setDescription(
                                                            eval(
                                                                client.la[ls]["cmds"]["administration"]["warn"]["variable23"]
                                                            )
                                                        ),
                                                ],
                                            });
                                            ...
                                            .send({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setTitle(
                                                            eval(
                                                                client.la[ls]["handlers"]["antilinksjs"]["antilinks"][
                                                                    "variable1"
                                                                ]
                                                            )
                                                        )
                                    ...
                                    .send({
                                        embeds: [
                                            new EmbedBuilder()
                                                ...
                                                .setFooter(client.getFooter(es))
                                                .setTitle(
                                                    eval(client.la[ls]["handlers"]["antilinksjs"]["antilinks"]["variable5"])
                                                ),
                                        ],
                                    })
                                    .then(msg =>
                        ...
                        .send({
                            embeds: [
                                new EmbedBuilder()
                                    ...
                                    .setTitle(client.la[ls].common.erroroccur)
                                    .setDescription(
                                        eval(client.la[ls]["handlers"]["antilinksjs"]["antilinks"]["variable6"])
                                    ),
                            ],
                        })
                        .catch(() => {});
