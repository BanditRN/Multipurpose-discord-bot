...
module.exports = client => {
    client.on("messageCreate", async message => {
        try {
            ...
            if (
                client.blacklist
                    .get(message.guild.id, "whitelistedchannels")
                    .some(r => message.channel.parentId == r || message.channel.id == r)
            )
                return;
                            ...
                            message.channel.send({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            `> <@${message.author.id}> **received an autogenerated Warn - \`blacklist\`**!\n\n> **He now has \`${warnings.length} Warnings\`**`
                                        ),
                                ],
                            });
                                        ...
                                        message.member.send({
                                            embeds: [
                                                new EmbedBuilder()
                                                    ...
                                                    .setFooter(client.getFooter(es))
                                                    .setTitle(
                                                        eval(client.la[ls]["cmds"]["administration"]["warn"]["variable9"])
                                                    )
                                                    .setDescription(
                                                        eval(client.la[ls]["cmds"]["administration"]["warn"]["variable10"])
                                                    ),
                                            ],
                                        });
                                    } catch {
                                        return message.channel.send({
                                            embeds: [
                                                new EmbedBuilder()
                                                    ...
                                                    .setFooter(client.getFooter(es))
                                                    .setTitle(
                                                        eval(client.la[ls]["cmds"]["administration"]["warn"]["variable11"])
                                                    )
                                                    .setDescription(
                                                        eval(client.la[ls]["cmds"]["administration"]["warn"]["variable12"])
                                                    ),
                                            ],
                                        });
                                    }
                                        ...
                                        message.channel.send({
                                            embeds: [
                                                new EmbedBuilder()
                                                    ...
                                                    .setDescription(
                                                        eval(client.la[ls]["cmds"]["administration"]["warn"]["variable15"])
                                                    ),
                                            ],
                                        });
                                    }
                                        ...
                                        message.member.send({
                                            embeds: [
                                                new EmbedBuilder()
                                                    ...
                                                    .setFooter(client.getFooter(es))
                                                    .setTitle(
                                                        eval(client.la[ls]["cmds"]["administration"]["warn"]["variable17"])
                                                    ),
                                            ],
                                        });
                                    } catch {
                                        message.channel.send({
                                            embeds: [
                                                new EmbedBuilder()
                                                    ...
                                                    .setFooter(client.getFooter(es))
                                                    .setTitle(
                                                        eval(client.la[ls]["cmds"]["administration"]["warn"]["variable18"])
                                                    )
                                                    .setDescription(
                                                        eval(client.la[ls]["cmds"]["administration"]["warn"]["variable19"])
                                                    ),
                                            ],
                                        });
                                    }
                                        ...
                                        message.channel.send({
                                            embeds: [
                                                new EmbedBuilder()
                                                    ...
                                                    .setFooter(client.getFooter(es))
                                                    .setTitle(
                                                        eval(client.la[ls]["cmds"]["administration"]["warn"]["variable22"])
                                                    )
                                                    .setDescription(
                                                        eval(client.la[ls]["cmds"]["administration"]["warn"]["variable23"])
                                                    ),
                                            ],
                                        });
                                    }
                                        ...
                                        .send({
                                            embeds: [
                                                new EmbedBuilder()
                                                    ...
                                                    .setTitle(
                                                        eval(
                                                            client.la[ls]["handlers"]["blacklistjs"]["blacklist"][
                                                                "variable1"
                                                            ]
                                                        )
                                                    )
                                ...
                                .send({
                                    embeds: [
                                        new EmbedBuilder()
                                            ...
                                            .setFooter(client.getFooter(es))
                                            .setTitle(
                                                eval(client.la[ls]["handlers"]["blacklistjs"]["blacklist"]["variable5"])
                                            ),
                                    ],
                                })
                                .then(msg => {
