                        ...
                        message.channel.send({
                            embeds: [
                                new EmbedBuilder()
                                    ...
                                    .setDescription(
                                        `> <@${message.author.id}> **received an autogenerated Warn - \`anticaps\`**!\n\n> **He now has \`${warnings.length} Warnings\`**`
                                    ),
                            ],
                        });
                                            ...
                                            message.channel.send({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setTitle(
                                                            eval(
                                                                client.la[ls]["cmds"]["administration"]["warn"]["variable13"]
                                                            )
                                                        )
                                                        .setDescription(
                                                            eval(
                                                                client.la[ls]["cmds"]["administration"]["warn"]["variable14"]
                                                            )
                                                        ),
                                                ],
                                            });
                                            ...
                                            message.channel.send({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        ...
                                                        .setTitle(
                                                            eval(
                                                                client.la[ls]["cmds"]["administration"]["warn"]["variable20"]
                                                            )
                                                        )
                                                        .setDescription(
                                                            eval(
                                                                client.la[ls]["cmds"]["administration"]["warn"]["variable21"]
                                                            )
                                                        ),
                                                ],
                                            });
                                    ...
                                    .send({
                                        embeds: [
                                            new EmbedBuilder()
                                                ...
                                                .setFooter(client.getFooter(es))
                                                .setTitle(
                                                    eval(client.la[ls]["handlers"]["anticapsjs"]["anticaps"]["variable1"])
                                                )
                                                .setDescription(
                                                    eval(client.la[ls]["handlers"]["anticapsjs"]["anticaps"]["variable2"])
                                                ),
                                        ],
                                    })
                                    .catch(() => {});
                            ...
                            .send({
                                embeds: [
                                    new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            eval(client.la[ls]["handlers"]["anticapsjs"]["anticaps"]["variable6"])
                                        ),
                                ],
                            })
                            .then(msg =>
